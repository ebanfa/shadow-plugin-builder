...
INSERT INTO business (id, currency, entity_code, name, user_name, pin, tel_no, account_notify_email, orders_notify_email, address_1, address_2, description) VALUES (1, 1, 'DEFAULT', 'African Fabric & Designs', 'admin@africanfabricanddesigns.com', '0000000', '254 0710 660 524', 'accounts@africanfabricanddesigns.com', 'info@africanfabricanddesigns.com', 'Shop No. 26 Adams arcade mini mall', 'Opposite Shell Petrol station along Suna road, (Right after Iran Medical Clinic)', 'African Fabric & Designs');
...
INSERT INTO productcategory (id, entity_code, name, description) VALUES (1, 'CLOTHING', 'Clothing', 'Clothing');
INSERT INTO productcategory (id, entity_code, name, description) VALUES (2, 'SHOES', 'Shoes', 'Shoes');
INSERT INTO productcategory (id, entity_code, name, description) VALUES (3, 'ACCESSORIES', 'Accessories', 'Accessories');


/* Insert statement for Product Type */
INSERT INTO producttype (id, prod_cat, entity_code, name, description) VALUES (1, 1, 'DRESSES', 'Dresses', 'Dresses');
INSERT INTO producttype (id, prod_cat, entity_code, name, description) VALUES (2, 1, 'PANTS_LEGGINGS', 'Pants & Leggings', 'Pants & Leggings');
INSERT INTO producttype (id, prod_cat, entity_code, name, description) VALUES (3, 1, 'JACKETS', 'Jackets', 'Jackets');
INSERT INTO producttype (id, prod_cat, entity_code, name, description) VALUES (4, 1, 'JEANS', 'Jeans', 'Jeans');
INSERT INTO producttype (id, prod_cat, entity_code, name, description) VALUES (5, 1, 'SHORTS', 'Shorts', 'Shorts');
...
INSERT INTO product (id, prod_type, entity_code, name, description) VALUES (1, 1, 'SHORT_GOWN', 'Short Gown', 'Short Gown');
