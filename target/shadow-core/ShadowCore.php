...
class ShadowCore {
    ...
    public function includes() {
        ...
        include_once('includes/abstracts/PartyAddress.php');
        ...
        include_once('includes/abstracts/PurchaseAgreementInspection.php');
        ...
        include_once('includes/abstracts/WorkEffortFixedAssignmentStatus.php');
        include_once('includes/abstracts/WorkEffortFixedAssetAssignmentCPT.php');
        include_once('includes/abstracts/WorkEffortFixedAssetAssignment.php');
        include_once('includes/abstracts/PartyFixedAssetAssignmentStatusCPT.php');
        include_once('includes/abstracts/PartyFixedAssetAssignmentStatus.php');
        include_once('includes/abstracts/PartyFixedAssetAssignmentCPT.php');
        include_once('includes/abstracts/PartyFixedAssetAssignment.php');
