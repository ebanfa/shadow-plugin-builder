...
class ShadowCore {
    ...
    public function includes() {
        // Model
        include_once('includes/abstracts/LoanApplicationCPT.php');
        ...
        include_once('includes/abstracts/PartyAddressCPT.php');
        include_once('includes/abstracts/PartyFilesCPT.php');
        include_once('includes/abstracts/ChargeCategoryCPT.php');
        ...
        include_once('includes/abstracts/ExpenseCategoryCPT.php');
        ...
        include_once('includes/abstracts/FixedAssetTypeCPT.php');
        ...
        include_once('includes/abstracts/FixedAssetCPT.php');
        include_once('includes/abstracts/InventoryCPT.php');
        include_once('includes/abstracts/PropertyInventoryItemCPT.php');
        include_once('includes/abstracts/PropertyExpenseCPT.php');
        ...
        include_once('includes/abstracts/BuildingExpenseCPT.php');
        ...
        include_once('includes/abstracts/FacilityExpenseCPT.php');
        include_once('includes/abstracts/ParkingSlotTypeCPT.php');
        include_once('includes/abstracts/ParkingSlotTypeChargeCPT.php');
        include_once('includes/abstracts/ParkingSlotTypeExpenseCPT.php');
        ...
        include_once('includes/abstracts/PurchaseAgreementInspectionCPT.php');
        include_once('includes/abstracts/AgreementItemTypeCPT.php');
        include_once('includes/abstracts/AgreementItemCPT.php');
        include_once('includes/abstracts/RentAgreementCPT.php');
        include_once('includes/abstracts/ServiceAgreementCPT.php');
        include_once('includes/abstracts/ManagementAgreementCPT.php');
        ...
        include_once('includes/abstracts/LandAssessmentCPT.php');
        ...
        include_once('includes/abstracts/OutPaymentCPT.php');
        include_once('includes/abstracts/PayrollCPT.php');
        ...
        include_once('includes/abstracts/InspectionCPT.php');
        include_once('includes/abstracts/MaintenanceCPT.php');
        ...
        include_once('includes/abstracts/WorkEffortFixedAssignmentStatusCPT.php');
        include_once('includes/abstracts/WorkEffortFixedAssetAssignmentCPT.php');
        include_once('includes/abstracts/PartyFixedAssetAssignmentStatusCPT.php');
        include_once('includes/abstracts/PartyFixedAssetAssignmentCPT.php');
    ...
    public function init_admin_template_hooks(){
        add_filter('manage_sb_loanapp_posts_columns', 'LoanApplicationCPT::sb_loanapp_table_head');
        add_action('manage_sb_loanapp_posts_custom_column', 'LoanApplicationCPT::sb_loanapp_table_content', 10, 2);
        ...
        add_filter('manage_sb_partyaddress_posts_columns', 'PartyAddressCPT::sb_partyaddress_table_head');
        add_action('manage_sb_partyaddress_posts_custom_column', 'PartyAddressCPT::sb_partyaddress_table_content', 10, 2);
        ...
        add_filter('manage_sb_chargecat_posts_columns', 'ChargeCategoryCPT::sb_chargecat_table_head');
        add_action('manage_sb_chargecat_posts_custom_column', 'ChargeCategoryCPT::sb_chargecat_table_content', 10, 2);
        ...
        add_filter('manage_sb_expensecat_posts_columns', 'ExpenseCategoryCPT::sb_expensecat_table_head');
        add_action('manage_sb_expensecat_posts_custom_column', 'ExpenseCategoryCPT::sb_expensecat_table_content', 10, 2);
        ...
        add_filter('manage_sb_fassettype_posts_columns', 'FixedAssetTypeCPT::sb_fassettype_table_head');
        add_action('manage_sb_fassettype_posts_custom_column', 'FixedAssetTypeCPT::sb_fassettype_table_content', 10, 2);
        ...
        add_filter('manage_sb_fixedasset_posts_columns', 'FixedAssetCPT::sb_fixedasset_table_head');
        add_action('manage_sb_fixedasset_posts_custom_column', 'FixedAssetCPT::sb_fixedasset_table_content', 10, 2);
        ...
        add_filter('manage_sb_piitem_posts_columns', 'PropertyInventoryItemCPT::sb_piitem_table_head');
        add_action('manage_sb_piitem_posts_custom_column', 'PropertyInventoryItemCPT::sb_piitem_table_content', 10, 2);
        add_filter('manage_sb_pexpense_posts_columns', 'PropertyExpenseCPT::sb_pexpense_table_head');
        add_action('manage_sb_pexpense_posts_custom_column', 'PropertyExpenseCPT::sb_pexpense_table_content', 10, 2);
        ...
        add_filter('manage_sb_bexpense_posts_columns', 'BuildingExpenseCPT::sb_bexpense_table_head');
        add_action('manage_sb_bexpense_posts_custom_column', 'BuildingExpenseCPT::sb_bexpense_table_content', 10, 2);
        ...
        add_filter('manage_sb_fexpense_posts_columns', 'FloorExpenseCPT::sb_fexpense_table_head');
        add_action('manage_sb_fexpense_posts_custom_column', 'FloorExpenseCPT::sb_fexpense_table_content', 10, 2);
        ...
        add_filter('manage_sb_utypeexpense_posts_columns', 'UnitTypeExpenseCPT::sb_utypeexpense_table_head');
        add_action('manage_sb_utypeexpense_posts_custom_column', 'UnitTypeExpenseCPT::sb_utypeexpense_table_content', 10, 2);
        ...
        add_filter('manage_sb_unitexpense_posts_columns', 'UnitExpenseCPT::sb_unitexpense_table_head');
        add_action('manage_sb_unitexpense_posts_custom_column', 'UnitExpenseCPT::sb_unitexpense_table_content', 10, 2);
        ...
        add_filter('manage_sb_feexpense_posts_columns', 'FacilityExpenseCPT::sb_feexpense_table_head');
        add_action('manage_sb_feexpense_posts_custom_column', 'FacilityExpenseCPT::sb_feexpense_table_content', 10, 2);
        ...
        add_filter('manage_sb_pstypeexpense_posts_columns', 'ParkingSlotTypeExpenseCPT::sb_pstypeexpense_table_head');
        add_action('manage_sb_pstypeexpense_posts_custom_column', 'ParkingSlotTypeExpenseCPT::sb_pstypeexpense_table_content', 10, 2);
        ...
        add_filter('manage_sb_agrmntinspection_posts_columns', 'PurchaseAgreementInspectionCPT::sb_agrmntinspection_table_head');
        add_action('manage_sb_agrmntinspection_posts_custom_column', 'PurchaseAgreementInspectionCPT::sb_agrmntinspection_table_content', 10, 2);
        ...
        add_filter('manage_sb_rentagreement_posts_columns', 'RentAgreementCPT::sb_rentagreement_table_head');
        add_action('manage_sb_rentagreement_posts_custom_column', 'RentAgreementCPT::sb_rentagreement_table_content', 10, 2);
        add_filter('manage_sb_seragreement_posts_columns', 'ServiceAgreementCPT::sb_seragreement_table_head');
        add_action('manage_sb_seragreement_posts_custom_column', 'ServiceAgreementCPT::sb_seragreement_table_content', 10, 2);
        add_filter('manage_sb_managreement_posts_columns', 'ManagementAgreementCPT::sb_managreement_table_head');
        add_action('manage_sb_managreement_posts_custom_column', 'ManagementAgreementCPT::sb_managreement_table_content', 10, 2);
        ...
        add_filter('manage_sb_landassmnt_posts_columns', 'LandAssessmentCPT::sb_landassmnt_table_head');
        add_action('manage_sb_landassmnt_posts_custom_column', 'LandAssessmentCPT::sb_landassmnt_table_content', 10, 2);
        ...
        add_filter('manage_sb_outpayment_posts_columns', 'OutPaymentCPT::sb_outpayment_table_head');
        add_action('manage_sb_outpayment_posts_custom_column', 'OutPaymentCPT::sb_outpayment_table_content', 10, 2);
        add_filter('manage_sb_payroll_posts_columns', 'PayrollCPT::sb_payroll_table_head');
        add_action('manage_sb_payroll_posts_custom_column', 'PayrollCPT::sb_payroll_table_content', 10, 2);
        ...
        add_filter('manage_sb_inspection_posts_columns', 'InspectionCPT::sb_inspection_table_head');
        add_action('manage_sb_inspection_posts_custom_column', 'InspectionCPT::sb_inspection_table_content', 10, 2);
        add_filter('manage_sb_maintenance_posts_columns', 'MaintenanceCPT::sb_maintenance_table_head');
        add_action('manage_sb_maintenance_posts_custom_column', 'MaintenanceCPT::sb_maintenance_table_content', 10, 2);
        ...
        add_filter('manage_sb_wefaastatus_posts_columns', 'WorkEffortFixedAssignmentStatusCPT::sb_wefaastatus_table_head');
        add_action('manage_sb_wefaastatus_posts_custom_column', 'WorkEffortFixedAssignmentStatusCPT::sb_wefaastatus_table_content', 10, 2);
        add_filter('manage_sb_wefaassign_posts_columns', 'WorkEffortFixedAssetAssignmentCPT::sb_wefaassign_table_head');
        add_action('manage_sb_wefaassign_posts_custom_column', 'WorkEffortFixedAssetAssignmentCPT::sb_wefaassign_table_content', 10, 2);
        add_filter('manage_sb_wepastatus_posts_columns', 'PartyFixedAssetAssignmentStatusCPT::sb_wepastatus_table_head');
        add_action('manage_sb_wepastatus_posts_custom_column', 'PartyFixedAssetAssignmentStatusCPT::sb_wepastatus_table_content', 10, 2);
        add_filter('manage_sb_pfaassign_posts_columns', 'PartyFixedAssetAssignmentCPT::sb_pfaassign_table_head');
        add_action('manage_sb_pfaassign_posts_custom_column', 'PartyFixedAssetAssignmentCPT::sb_pfaassign_table_content', 10, 2);
