...
class PurchaseOrderViewFilter extends CategorizedViewFilter {

    /**
     *
     */
    public static function init_hooks() { 
        add_filter('shadowbanker_purchaseorder_form_fields', array('PurchaseOrderViewFilter', 'filter_form_fields'), 10, 2);
        add_filter('shadowbanker_purchaseorder_action_links', array('PurchaseOrderViewFilter', 'filter_view_action_links'), 10, 2);
    }
