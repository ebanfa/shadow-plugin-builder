...
class LandTopographyCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_ltopography'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_ltopography', 
            array(
                'label' => 'Land Topography',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Land Topography',
                'edit_item'         => 'Edit Land Topography',
                'new_item'          => 'New Land Topography',
                'view_item'         => 'View Land Topography',
                'search_items'      => 'Search Land Topography',
                'not_found'         => 'No Land Topography Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Land Topography',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_ltopography') 
        {
    ...
    public static function sb_ltopography_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_ltopography_table_content($column_name, $post_id){
