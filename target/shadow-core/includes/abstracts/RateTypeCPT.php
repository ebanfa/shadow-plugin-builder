...
class RateTypeCPT {
    ...
    public static $post_name = 'sb_ratetype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_ratetype', 
            array(
                'label' => 'Rate Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Rate Type',
                'edit_item'         => 'Edit Rate Type',
                'new_item'          => 'New Rate Type',
                'view_item'         => 'View Rate Type',
                'search_items'      => 'Search Rate Type',
                'not_found'         => 'No Rate Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Rate Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_ratetype_table_head($defaults){
        $defaults['name']  = 'name';
    ...
    public static function sb_ratetype_table_content($column_name, $post_id){
