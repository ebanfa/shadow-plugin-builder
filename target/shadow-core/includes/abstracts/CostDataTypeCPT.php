...
class CostDataTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_cdtype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_cdtype', 
            array(
                'label' => 'Cost Data Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Cost Data Type',
                'edit_item'         => 'Edit Cost Data Type',
                'new_item'          => 'New Cost Data Type',
                'view_item'         => 'View Cost Data Type',
                'search_items'      => 'Search Cost Data Type',
                'not_found'         => 'No Cost Data Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Cost Data Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_cdtype_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_cdtype_table_content($column_name, $post_id){
