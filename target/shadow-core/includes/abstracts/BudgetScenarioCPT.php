...
class BudgetScenarioCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_budgetscenario'; 
 ...
 public static $related_child_entities = array(
        'budget_scenario' => array('name' => 'budget_scenario',
            'entity_name' => 'BudgetScenarioRule',
            'data_type' => 'sb_bscenariorule',
            'artifact_name' => 'budgetscenariorule',
            'entity_description' => 'Budget Scenario Rule',
            'is_relationship_field' => true,
            'fields' => array(
                'entity_code' => array('name' => 'entity_code',
                    'description' => 'Code',
    ...
    {
       register_post_type('sb_budgetscenario', 
            array(
                'label' => 'Budget Scenario',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Budget Scenario',
                'edit_item'         => 'Edit Budget Scenario',
                'new_item'          => 'New Budget Scenario',
                'view_item'         => 'View Budget Scenario',
                'search_items'      => 'Search Budget Scenario',
                'not_found'         => 'No Budget Scenario Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Budget Scenario',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_budgetscenario') 
        {
    ...
    public static function sb_budgetscenario_table_head($defaults){
        $defaults['name']  = 'Name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_budgetscenario_table_content($column_name, $post_id){
