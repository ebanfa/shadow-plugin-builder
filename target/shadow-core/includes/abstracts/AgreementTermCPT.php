...
class AgreementTermCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_agreeterm'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_agreeterm', 
            array(
                'label' => 'Agreement Term',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Agreement Term',
                'edit_item'         => 'Edit Agreement Term',
                'new_item'          => 'New Agreement Term',
                'view_item'         => 'View Agreement Term',
                'search_items'      => 'Search Agreement Term',
                'not_found'         => 'No Agreement Term Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Agreement Term',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_agreeterm') 
        {
    ...
    public static function sb_agreeterm_table_head($defaults){
        $defaults['at_agreement']  = 'Agreement';
        $defaults['at_term']  = 'Term';
        $defaults['name']  = 'name';
    ...
    public static function sb_agreeterm_table_content($column_name, $post_id){
        if ($column_name == 'entity_code') {
            $field_value = get_post_meta($post_id, 'entity_code', true );
            echo $field_value;
        }
        if ($column_name == 'at_agreement') {
            $field_value = get_post_meta($post_id, 'at_agreement', true );
            echo $field_value;
        }
        if ($column_name == 'at_term') {
            $field_value = get_post_meta($post_id, 'at_term', true );
            echo $field_value;
        }
        if ($column_name == 'name') {
