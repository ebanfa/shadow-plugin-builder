...
class PerfReviewItemTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_previtemtype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_previtemtype', 
            array(
                'label' => 'Performance Review Item Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Performance Review Item Type',
                'edit_item'         => 'Edit Performance Review Item Type',
                'new_item'          => 'New Performance Review Item Type',
                'view_item'         => 'View Performance Review Item Type',
                'search_items'      => 'Search Performance Review Item Type',
                'not_found'         => 'No Performance Review Item Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Performance Review Item Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_previtemtype') 
        {
    ...
    public static function sb_previtemtype_table_head($defaults){
        $defaults['name']  = 'name';
    ...
    public static function sb_previtemtype_table_content($column_name, $post_id){
