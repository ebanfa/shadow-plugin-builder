...
class DisbursementCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_disbursement'; 
    ...
    public static $custom_fields =  array(
        ...
        array('name' => 'type',
            ...
            'description' => 'The Disbursement Type field',
            'type' => 'text',
        ),
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_disbursement', 
            array(
                'label' => 'Disbursement',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Disbursement',
                'edit_item'         => 'Edit Disbursement',
                'new_item'          => 'New Disbursement',
                'view_item'         => 'View Disbursement',
                'search_items'      => 'Search Disbursement',
                'not_found'         => 'No Disbursement Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Disbursement',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_disbursement') 
        {
    ...
    public static function sb_disbursement_table_head($defaults){
        $defaults['type']  = 'Disbursement Type';
        $defaults['p_methtype']  = 'Payment Method Type';
        $defaults['d_fpartyrole']  = 'From Party Role';
        $defaults['d_tpartyrole']  = 'To Party Role';
        $defaults['name']  = 'name';
    ...
    public static function sb_disbursement_table_content($column_name, $post_id){
        ...
        if ($column_name == 'd_fpartyrole') {
            $field_value = get_post_meta($post_id, 'd_fpartyrole', true );
            echo $field_value;
        }
        if ($column_name == 'd_tpartyrole') {
            $field_value = get_post_meta($post_id, 'd_tpartyrole', true );
            echo $field_value;
        }
        if ($column_name == 'd_payment') {
            $field_value = get_post_meta($post_id, 'd_payment', true );
            echo $field_value;
        }
        if ($column_name == 'name') {
