...
class EmploymentApplicationSourceTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_empappsrctype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_empappsrctype', 
            array(
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_empappsrctype') 
        {
    ...
    public static function sb_empappsrctype_table_head($defaults){
        $defaults['name']  = 'name';
    ...
    public static function sb_empappsrctype_table_content($column_name, $post_id){
