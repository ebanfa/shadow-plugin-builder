...
class PaymentBudgetAllocationCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_pballocation'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_pballocation', 
            array(
                'label' => 'Payment Budget Allocation',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Payment Budget Allocation',
                'edit_item'         => 'Edit Payment Budget Allocation',
                'new_item'          => 'New Payment Budget Allocation',
                'view_item'         => 'View Payment Budget Allocation',
                'search_items'      => 'Search Payment Budget Allocation',
                'not_found'         => 'No Payment Budget Allocation Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Payment Budget Allocation',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_pballocation') 
        {
    ...
    public static function sb_pballocation_table_head($defaults){
        $defaults['budget']  = 'Budget';
        $defaults['payment']  = 'Budget';
        $defaults['name']  = 'Name';
    ...
    public static function sb_pballocation_table_content($column_name, $post_id){
