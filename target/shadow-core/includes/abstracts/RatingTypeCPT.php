...
class RatingTypeCPT {
    ...
    public static $post_name = 'sb_ratingtype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_ratingtype', 
            array(
                'label' => 'Rating Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Rating Type',
                'edit_item'         => 'Edit Rating Type',
                'new_item'          => 'New Rating Type',
                'view_item'         => 'View Rating Type',
                'search_items'      => 'Search Rating Type',
                'not_found'         => 'No Rating Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Rating Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_ratingtype') 
        {
    ...
    public static function sb_ratingtype_table_head($defaults){
        $defaults['name']  = 'name';
    ...
    public static function sb_ratingtype_table_content($column_name, $post_id){
