...
class PurchaseOrderItemCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_porderitem'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_porderitem', 
            array(
                'label' => 'Purchase Order Item',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Purchase Order Item',
                'edit_item'         => 'Edit Purchase Order Item',
                'new_item'          => 'New Purchase Order Item',
                'view_item'         => 'View Purchase Order Item',
                'search_items'      => 'Search Purchase Order Item',
                'not_found'         => 'No Purchase Order Item Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Purchase Order Item',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_porderitem') 
        {
    ...
    public static function sb_porderitem_table_head($defaults){
        $defaults['name']  = 'Name';
    ...
    public static function sb_porderitem_table_content($column_name, $post_id){
