...
class LandAccessibilityCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_laccessibility'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_laccessibility', 
            array(
                'label' => 'Land Accessibility',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Land Accessibility',
                'edit_item'         => 'Edit Land Accessibility',
                'new_item'          => 'New Land Accessibility',
                'view_item'         => 'View Land Accessibility',
                'search_items'      => 'Search Land Accessibility',
                'not_found'         => 'No Land Accessibility Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Land Accessibility',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_laccessibility') 
        {
    ...
    public static function sb_laccessibility_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_laccessibility_table_content($column_name, $post_id){
