...
class SalesDataItemTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_sditemtype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_sditemtype', 
            array(
                'label' => 'Sales Data Item Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Sales Data Item Type',
                'edit_item'         => 'Edit Sales Data Item Type',
                'new_item'          => 'New Sales Data Item Type',
                'view_item'         => 'View Sales Data Item Type',
                'search_items'      => 'Search Sales Data Item Type',
                'not_found'         => 'No Sales Data Item Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Sales Data Item Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_sditemtype') 
        {
    ...
    public static function sb_sditemtype_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_sditemtype_table_content($column_name, $post_id){
