...
class AccountTransactionStatusCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_accttxnstatus'; 
 ...
 public static $related_child_entities = array(
        'status' => array('name' => 'status',
            ...
            'fields' => array(
                ...
                'acct_txn_type' => array('name' => 'acct_txn_type',
                    'description' => 'Account Transaction Type',
                    'size' => 'large',
                    ...
                    'is_relationship_field' => true,),
                'status' => array('name' => 'status',
                    'description' => 'Account Transaction Status',
                    'size' => 'large',
    ...
    {
       register_post_type('sb_accttxnstatus', 
            array(
                'label' => 'Account Transaction Status',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Account Transaction Status',
                'edit_item'         => 'Edit Account Transaction Status',
                'new_item'          => 'New Account Transaction Status',
                'view_item'         => 'View Account Transaction Status',
                'search_items'      => 'Search Account Transaction Status',
                'not_found'         => 'No Account Transaction Status Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Account Transaction Status',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_accttxnstatus') 
        {
    ...
    public static function sb_accttxnstatus_table_head($defaults){
    ...
    public static function sb_accttxnstatus_table_content($column_name, $post_id){
