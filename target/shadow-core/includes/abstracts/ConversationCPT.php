...
class ConversationCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_conversation'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_conversation', 
            array(
                'label' => 'Conversation',
                'labels' => array(
                'add_new'           => 'Add New',
                ...
                'description' => 'Reusable Conversation',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_conversation') 
        {
