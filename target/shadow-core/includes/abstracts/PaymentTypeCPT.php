...
class PaymentTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_paymenttype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_paymenttype', 
            array(
                'label' => 'Payment Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Payment Type',
                'edit_item'         => 'Edit Payment Type',
                'new_item'          => 'New Payment Type',
                'view_item'         => 'View Payment Type',
                'search_items'      => 'Search Payment Type',
                'not_found'         => 'No Payment Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Payment Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_paymenttype') 
        {
    ...
    public static function sb_paymenttype_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_paymenttype_table_content($column_name, $post_id){
