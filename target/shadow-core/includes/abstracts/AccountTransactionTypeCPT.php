...
class AccountTransactionTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_accttxntype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_accttxntype', 
            array(
                'label' => 'Account Transaction Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Account Transaction Type',
                'edit_item'         => 'Edit Account Transaction Type',
                'new_item'          => 'New Account Transaction Type',
                'view_item'         => 'View Account Transaction Type',
                'search_items'      => 'Search Account Transaction Type',
                'not_found'         => 'No Account Transaction Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Account Transaction Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_accttxntype') 
        {
    ...
    public static function sb_accttxntype_table_head($defaults){
    ...
    public static function sb_accttxntype_table_content($column_name, $post_id){
