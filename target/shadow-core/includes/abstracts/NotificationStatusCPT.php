...
class NotificationStatusCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_notifystatus'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_notifystatus', 
            array(
                'label' => 'Notification Status',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Notification Status',
                'edit_item'         => 'Edit Notification Status',
                'new_item'          => 'New Notification Status',
                'view_item'         => 'View Notification Status',
                'search_items'      => 'Search Notification Status',
                'not_found'         => 'No Notification Status Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Notification Status',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_notifystatus') 
        {
    ...
    public static function sb_notifystatus_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_notifystatus_table_content($column_name, $post_id){
