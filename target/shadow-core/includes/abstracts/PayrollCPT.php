...
class PayrollCPT {
    ...
    public static $post_name = 'sb_payroll'; 
 ...
 public static $related_child_entities = array(
    ...
    public static function register_custom_post_type()
    {
       register_post_type('sb_payroll', 
            array(
                ...
                'not_found'         => 'No Payroll Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Payroll',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_payroll_table_head($defaults){
        $defaults['name']  = 'name';
        return $defaults;
    }

    public static function sb_payroll_table_content($column_name, $post_id){
