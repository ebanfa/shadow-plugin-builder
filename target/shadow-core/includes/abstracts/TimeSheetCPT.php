...
class TimeSheetCPT {
    ...
    public static $post_name = 'sb_timesheet'; 
 ...
 public static $related_child_entities = array(
        'timesheet' => array('name' => 'timesheet',
            ...
            'data_type' => 'sb_timeentry',
            'artifact_name' => 'timeentry',
            'entity_description' => 'Time Entry',
            'is_relationship_field' => true,
            'fields' => array(
                'entity_code' => array('name' => 'entity_code',
                    'description' => 'Code',
    ...
    {
       register_post_type('sb_timesheet', 
            array(
                'label' => 'Time Sheet',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Time Sheet',
                'edit_item'         => 'Edit Time Sheet',
                'new_item'          => 'New Time Sheet',
                'view_item'         => 'View Time Sheet',
                'search_items'      => 'Search Time Sheet',
                'not_found'         => 'No Time Sheet Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Time Sheet',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_timesheet') 
        {
    ...
    public static function sb_timesheet_table_head($defaults){
        $defaults['submitter']  = 'Party';
        $defaults['name']  = 'name';
    ...
    public static function sb_timesheet_table_content($column_name, $post_id){
        if ($column_name == 'entity_code') {
            $field_value = get_post_meta($post_id, 'entity_code', true );
            echo $field_value;
        }
        if ($column_name == 'submitter') {
            $field_value = get_post_meta($post_id, 'submitter', true );
            echo $field_value;
        }
        if ($column_name == 'name') {
