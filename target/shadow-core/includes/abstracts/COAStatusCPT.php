...
class COAStatusCPT {
    ...
    public static $post_name = 'sb_coastatus'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_coastatus', 
            array(
                'label' => 'COA Status',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New COA Status',
                'edit_item'         => 'Edit COA Status',
                'new_item'          => 'New COA Status',
                'view_item'         => 'View COA Status',
                'search_items'      => 'Search COA Status',
                'not_found'         => 'No COA Status Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable COA Status',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_coastatus') 
        {
    ...
    public static function sb_coastatus_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_coastatus_table_content($column_name, $post_id){
