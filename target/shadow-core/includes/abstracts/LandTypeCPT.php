...
class LandTypeCPT {
    ...
    public static $post_name = 'sb_landtype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_landtype', 
            array(
                'label' => 'Land Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Land Type',
                'edit_item'         => 'Edit Land Type',
                'new_item'          => 'New Land Type',
                'view_item'         => 'View Land Type',
                'search_items'      => 'Search Land Type',
                'not_found'         => 'No Land Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Land Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_landtype_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_landtype_table_content($column_name, $post_id){
