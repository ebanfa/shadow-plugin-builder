...
class InspectionCPT {
    ...
    public static $post_name = 'sb_inspection'; 
 ...
 public static $related_child_entities = array(
        'pai_inspection' => array('name' => 'pai_inspection',
            ...
            'artifact_name' => 'agreementitemtype',
    ...
    {
       register_post_type('sb_inspection', 
            array(
                'label' => 'Inspection',
                'labels' => array(
                'add_new'           => 'Add New',
                ...
                'search_items'      => 'Search Inspection',
                'not_found'         => 'No Inspection Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Inspection',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_inspection') 
        {
    ...
    public static function sb_inspection_table_head($defaults){
        $defaults['name']  = 'name';
        return $defaults;
    }

    public static function sb_inspection_table_content($column_name, $post_id){
