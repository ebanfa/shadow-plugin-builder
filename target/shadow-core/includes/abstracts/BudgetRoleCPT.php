...
class BudgetRoleCPT {
    ...
    public static $post_name = 'sb_budgetrole'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_budgetrole', 
            array(
                'label' => 'Budget Role',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Budget Role',
                'edit_item'         => 'Edit Budget Role',
                'new_item'          => 'New Budget Role',
                'view_item'         => 'View Budget Role',
                'search_items'      => 'Search Budget Role',
                'not_found'         => 'No Budget Role Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Budget Role',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_budgetrole') 
        {
    ...
    public static function sb_budgetrole_table_head($defaults){
    ...
    public static function sb_budgetrole_table_content($column_name, $post_id){
