...
class EmploymentApplicationStatusCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_empappstatus'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_empappstatus', 
            array(
                'label' => 'Employment Application Status',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Employment Application Status',
                'edit_item'         => 'Edit Employment Application Status',
                'new_item'          => 'New Employment Application Status',
                'view_item'         => 'View Employment Application Status',
                'search_items'      => 'Search Employment Application Status',
                'not_found'         => 'No Employment Application Status Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Employment Application Status',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_empappstatus') 
        {
    ...
    public static function sb_empappstatus_table_head($defaults){
        $defaults['name']  = 'name';
    ...
    public static function sb_empappstatus_table_content($column_name, $post_id){
