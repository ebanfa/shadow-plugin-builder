...
class NotificationLevelCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_notifylevel'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_notifylevel', 
            array(
                'label' => 'Notification Level',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Notification Level',
                'edit_item'         => 'Edit Notification Level',
                'new_item'          => 'New Notification Level',
                'view_item'         => 'View Notification Level',
                'search_items'      => 'Search Notification Level',
                'not_found'         => 'No Notification Level Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Notification Level',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_notifylevel') 
        {
    ...
    public static function sb_notifylevel_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_notifylevel_table_content($column_name, $post_id){
