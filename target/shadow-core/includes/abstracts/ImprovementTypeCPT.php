...
class ImprovementTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_improvetype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_improvetype', 
            array(
                'label' => 'Improvement Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Improvement Type',
                'edit_item'         => 'Edit Improvement Type',
                'new_item'          => 'New Improvement Type',
                'view_item'         => 'View Improvement Type',
                'search_items'      => 'Search Improvement Type',
                'not_found'         => 'No Improvement Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Improvement Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_improvetype') 
        {
    ...
    public static function sb_improvetype_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_improvetype_table_content($column_name, $post_id){
