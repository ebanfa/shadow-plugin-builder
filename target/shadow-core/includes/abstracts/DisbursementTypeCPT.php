...
class DisbursementTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_disbursetype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_disbursetype', 
            array(
                'label' => 'Disbursement Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Disbursement Type',
                'edit_item'         => 'Edit Disbursement Type',
                'new_item'          => 'New Disbursement Type',
                'view_item'         => 'View Disbursement Type',
                'search_items'      => 'Search Disbursement Type',
                'not_found'         => 'No Disbursement Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Disbursement Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_disbursetype') 
        {
    ...
    public static function sb_disbursetype_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_disbursetype_table_content($column_name, $post_id){
