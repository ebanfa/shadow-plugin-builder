...
class ReceiptTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_receipttype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_receipttype', 
            array(
                'label' => 'Receipt Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Receipt Type',
                'edit_item'         => 'Edit Receipt Type',
                'new_item'          => 'New Receipt Type',
                'view_item'         => 'View Receipt Type',
                'search_items'      => 'Search Receipt Type',
                'not_found'         => 'No Receipt Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Receipt Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_receipttype') 
        {
    ...
    public static function sb_receipttype_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_receipttype_table_content($column_name, $post_id){
