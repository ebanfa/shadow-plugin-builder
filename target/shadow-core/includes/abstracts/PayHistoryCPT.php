...
class PayHistoryCPT {
    ...
    public static $post_name = 'sb_payhistory'; 
    ...
    public static $custom_fields =  array(
        ...
        array('name' => 'salary_step',
            'title' => 'Salary Step',
            'description' => 'The Salary Step field',
            'type' => 'text',
        ),
 ...
 public static $entity_fields = array(
        ...
        'salary_step' => array('name' => 'salary_step',
            'description' => 'Salary Step',
            'size' => 'large',
            'entity_name' => 'SalaryStep',
            'entity_description' => 'Salaray Step',
            'data_type' => 'sb_salarystep',
            'is_required' => true,
            'is_visible' => true,
            'is_create_field' => true,
            'is_edit_field' => true,
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_payhistory', 
            array(
                'label' => 'Pay History',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Pay History',
                'edit_item'         => 'Edit Pay History',
                'new_item'          => 'New Pay History',
                'view_item'         => 'View Pay History',
                'search_items'      => 'Search Pay History',
                'not_found'         => 'No Pay History Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Pay History',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_payhistory') 
        {
    ...
    public static function sb_payhistory_table_head($defaults){
        $defaults['period_type']  = 'Period Type';
        $defaults['salary_step']  = 'Salary Step';
    ...
    public static function sb_payhistory_table_content($column_name, $post_id){
        ...
        if ($column_name == 'salary_step') {
            $field_value = get_post_meta($post_id, 'salary_step', true );
            echo $field_value;
        }
