...
class TermTypeCPT {
    ...
    public static $post_name = 'sb_termtype'; 
 ...
 public static $related_child_entities = array(
        't_type' => array('name' => 't_type',
            ...
            'fields' => array(
                ...
                't_type' => array('name' => 't_type',
                    'description' => 'Type',
                    'size' => 'large',
                    'entity_name' => 'TermType',
                    'entity_description' => 'Term Type',
                    'data_type' => 'sb_termtype',
                    'is_required' => true,
                    'is_visible' => true,
                    'is_create_field' => true,
                    'is_edit_field' => true,
    ...
    {
       register_post_type('sb_termtype', 
            array(
                'label' => 'Term Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Term Type',
                'edit_item'         => 'Edit Term Type',
                'new_item'          => 'New Term Type',
                'view_item'         => 'View Term Type',
                'search_items'      => 'Search Term Type',
                'not_found'         => 'No Term Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Term Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
