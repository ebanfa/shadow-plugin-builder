...
class AccountTransactionCPT {
    ...
    public static $custom_fields =  array(
        ...
        array('name' => 'acct_txn_type',
            ...
            'description' => 'The Account Transaction Type field',
            'type' => 'text',
        ),
        array('name' => 'status',
            'title' => 'Account Transaction Status',
            'description' => 'The Account Transaction Status field',
            'type' => 'text',
        ),
        array('name' => 'name',
            'title' => 'Name',
 ...
 public static $related_child_entities = array(
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_accttransaction_table_head($defaults){
        $defaults['status']  = 'Account Transaction Status';
        $defaults['name']  = 'name';
