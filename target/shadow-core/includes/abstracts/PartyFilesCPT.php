...
class PartyFilesCPT {
    ...
    public static $post_name = 'sb_partyfiles'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_partyfiles', 
            array(
                'label' => 'Party Files',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Party Files',
                'edit_item'         => 'Edit Party Files',
                'new_item'          => 'New Party Files',
                'view_item'         => 'View Party Files',
                'search_items'      => 'Search Party Files',
                'not_found'         => 'No Party Files Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Party Files',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_partyfiles') 
        {
    ...
    public static function sb_partyfiles_table_head($defaults){
        $defaults['name']  = 'name';
    ...
    public static function sb_partyfiles_table_content($column_name, $post_id){
