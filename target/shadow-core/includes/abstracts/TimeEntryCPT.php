...
class TimeEntryCPT {
    ...
    public static $post_name = 'sb_timeentry'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_timeentry', 
            array(
                'label' => 'Time Entry',
                'labels' => array(
                'add_new'           => 'Add New',
                ...
                'search_items'      => 'Search Time Entry',
                'not_found'         => 'No Time Entry Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Time Entry',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_timeentry') 
        {
    ...
    public static function sb_timeentry_table_head($defaults){
    ...
    public static function sb_timeentry_table_content($column_name, $post_id){
        ...
        if ($column_name == 'hours') {
            $field_value = get_post_meta($post_id, 'hours', true );
            echo $field_value;
        }
