...
class AssetTypeCPT {
    ...
    public static $post_name = 'sb_assettype'; 
 ...
 public static $entity_fields = array(
        ...
        'category' => array('name' => 'category',
            ...
            'size' => 'large',
            'entity_name' => 'AssetCategory',
            'entity_description' => 'Asset Category',
            'data_type' => 'sb_assetcat',
            'is_required' => true,
            'is_visible' => true,
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_assettype', 
            array(
                'label' => 'Asset Type',
                'labels' => array(
                'add_new'           => 'Add New',
                ...
                'new_item'          => 'New Asset Type',
                'view_item'         => 'View Asset Type',
                'search_items'      => 'Search Asset Type',
                'not_found'         => 'No Asset Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Asset Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_assettype') 
        {
    ...
    public static function sb_assettype_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_assettype_table_content($column_name, $post_id){
