...
class BudgetScenarioApplicationCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_bscenarioapp'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_bscenarioapp', 
            array(
                'label' => 'Budget Scenario Application',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Budget Scenario Application',
                'edit_item'         => 'Edit Budget Scenario Application',
                'new_item'          => 'New Budget Scenario Application',
                'view_item'         => 'View Budget Scenario Application',
                'search_items'      => 'Search Budget Scenario Application',
                'not_found'         => 'No Budget Scenario Application Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Budget Scenario Application',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_bscenarioapp') 
        {
    ...
    public static function sb_bscenarioapp_table_head($defaults){
    ...
    public static function sb_bscenarioapp_table_content($column_name, $post_id){
