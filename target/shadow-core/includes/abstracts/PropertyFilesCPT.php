...
class PropertyFilesCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_propfiles'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_propfiles', 
            array(
                'label' => 'Property Files',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Property Files',
                'edit_item'         => 'Edit Property Files',
                'new_item'          => 'New Property Files',
                'view_item'         => 'View Property Files',
                'search_items'      => 'Search Property Files',
                'not_found'         => 'No Property Files Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Property Files',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_propfiles') 
        {
    ...
    public static function sb_propfiles_table_head($defaults){
        $defaults['name']  = 'name';
    ...
    public static function sb_propfiles_table_content($column_name, $post_id){
        if ($column_name == 'entity_code') {
            $field_value = get_post_meta($post_id, 'entity_code', true );
            echo $field_value;
        }
        if ($column_name == 'pf_property') {
            $field_value = get_post_meta($post_id, 'pf_property', true );
            echo $field_value;
        }
        if ($column_name == 'name') {
