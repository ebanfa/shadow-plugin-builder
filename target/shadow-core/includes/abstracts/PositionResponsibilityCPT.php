...
class PositionResponsibilityCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_posresp'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_posresp', 
            array(
                'label' => 'Position Responsibility',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Position Responsibility',
                'edit_item'         => 'Edit Position Responsibility',
                'new_item'          => 'New Position Responsibility',
                'view_item'         => 'View Position Responsibility',
                'search_items'      => 'Search Position Responsibility',
                'not_found'         => 'No Position Responsibility Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Position Responsibility',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_posresp_table_head($defaults){
    ...
    public static function sb_posresp_table_content($column_name, $post_id){
