...
class TermCPT {
    ...
    public static $post_name = 'sb_term'; 
 ...
 public static $related_child_entities = array(
    ...
    public static function register_custom_post_type()
    {
       register_post_type('sb_term', 
            array(
                ...
                'not_found'         => 'No Term Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Term',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_term_table_head($defaults){
        $defaults['t_type']  = 'Type';
        $defaults['name']  = 'name';
    ...
    public static function sb_term_table_content($column_name, $post_id){
