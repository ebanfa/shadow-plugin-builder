...
class FixedAssetTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_fassettype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_fassettype', 
            array(
                'label' => 'Fixed Asset Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Fixed Asset Type',
                'edit_item'         => 'Edit Fixed Asset Type',
                'new_item'          => 'New Fixed Asset Type',
                'view_item'         => 'View Fixed Asset Type',
                'search_items'      => 'Search Fixed Asset Type',
                'not_found'         => 'No Fixed Asset Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Fixed Asset Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_fassettype') 
        {
    ...
    public static function sb_fassettype_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_fassettype_table_content($column_name, $post_id){
