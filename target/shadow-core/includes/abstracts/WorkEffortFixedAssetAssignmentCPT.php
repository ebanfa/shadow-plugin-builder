...
class WorkEffortFixedAssetAssignmentCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_wefaassign'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_wefaassign', 
            array(
                'label' => 'Work Effort Fixed Asset Assignment',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Work Effort Fixed Asset Assignment',
                'edit_item'         => 'Edit Work Effort Fixed Asset Assignment',
                'new_item'          => 'New Work Effort Fixed Asset Assignment',
                'view_item'         => 'View Work Effort Fixed Asset Assignment',
                'search_items'      => 'Search Work Effort Fixed Asset Assignment',
                'not_found'         => 'No Work Effort Fixed Asset Assignment Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Work Effort Fixed Asset Assignment',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_wefaassign') 
        {
    ...
    public static function sb_wefaassign_table_head($defaults){
    ...
    public static function sb_wefaassign_table_content($column_name, $post_id){
