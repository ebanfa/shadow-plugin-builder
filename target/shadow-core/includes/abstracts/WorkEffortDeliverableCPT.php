...
class WorkEffortDeliverableCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_wedeliverable'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_wedeliverable', 
            array(
                'label' => 'Work Effort Deliverable',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Work Effort Deliverable',
                'edit_item'         => 'Edit Work Effort Deliverable',
                'new_item'          => 'New Work Effort Deliverable',
                'view_item'         => 'View Work Effort Deliverable',
                'search_items'      => 'Search Work Effort Deliverable',
                'not_found'         => 'No Work Effort Deliverable Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Work Effort Deliverable',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_wedeliverable') 
        {
    ...
    public static function sb_wedeliverable_table_head($defaults){
    ...
    public static function sb_wedeliverable_table_content($column_name, $post_id){
