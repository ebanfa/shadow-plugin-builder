...
class ResumeCPT {
    ...
    public static $post_name = 'sb_resume'; 
    ...
    public static $custom_fields =  array(
        ...
        array('name' => 'resume_date',
            'title' => 'Resume Date',
            'description' => 'The Resume Date field',
            'type' => 'text',
        ),
 ...
 public static $entity_fields = array(
        ...
        'name' => array('name' => 'name',
            ...
            'is_form_field' => true,
            'is_relationship_field' => false,),
        'resume_date' => array('name' => 'resume_date',
 ...
 public static $related_child_entities = array(
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_resume_table_head($defaults){
        $defaults['party']  = 'Party';
        $defaults['name']  = 'name';
        $defaults['resume_date']  = 'Resume Date';
        $defaults['description']  = 'Description';
        $defaults['business_unit']  = 'Business Unit';
        return $defaults;
    }

    public static function sb_resume_table_content($column_name, $post_id){
        ...
        if ($column_name == 'resume_date') {
            $field_value = get_post_meta($post_id, 'resume_date', true );
            echo $field_value;
        }
