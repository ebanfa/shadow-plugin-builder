...
class PlotCPT {
    ...
    public static $post_name = 'sb_plot'; 
    ...
    public static $custom_fields =  array(
        ...
        array('name' => 'p_type',
            'title' => 'Plot Type',
            'description' => 'The Plot Type field',
            'type' => 'text',
        ),
        array('name' => 'name',
            'title' => 'Name',
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_plot', 
            array(
                'label' => 'Plot',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Plot',
                'edit_item'         => 'Edit Plot',
                'new_item'          => 'New Plot',
                'view_item'         => 'View Plot',
                'search_items'      => 'Search Plot',
                'not_found'         => 'No Plot Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Plot',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_plot_table_head($defaults){
        $defaults['p_type']  = 'Plot Type';
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_plot_table_content($column_name, $post_id){
        if ($column_name == 'entity_code') {
            $field_value = get_post_meta($post_id, 'entity_code', true );
            echo $field_value;
        }
        if ($column_name == 'p_land') {
            $field_value = get_post_meta($post_id, 'p_land', true );
            echo $field_value;
        }
