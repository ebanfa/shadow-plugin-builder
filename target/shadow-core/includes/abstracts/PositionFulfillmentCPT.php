...
class PositionFulfillmentCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_pfulfillment'; 
    ...
    public static $custom_fields =  array(
        ...
        array('name' => 'acceptor',
            'title' => 'Acceptor',
            'description' => 'The Acceptor field',
            'type' => 'text',
        ),
        array('name' => 'name',
            'title' => 'Name',
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_pfulfillment', 
            array(
                'label' => 'Position Fulfillment',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Position Fulfillment',
                'edit_item'         => 'Edit Position Fulfillment',
                'new_item'          => 'New Position Fulfillment',
                'view_item'         => 'View Position Fulfillment',
                'search_items'      => 'Search Position Fulfillment',
                'not_found'         => 'No Position Fulfillment Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Position Fulfillment',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_pfulfillment') 
        {
    ...
    public static function sb_pfulfillment_table_head($defaults){
        $defaults['position']  = 'Position';
        $defaults['acceptor']  = 'Acceptor';
        $defaults['name']  = 'name';
    ...
    public static function sb_pfulfillment_table_content($column_name, $post_id){
        ...
        if ($column_name == 'acceptor') {
            $field_value = get_post_meta($post_id, 'acceptor', true );
            echo $field_value;
        }
        if ($column_name == 'name') {
