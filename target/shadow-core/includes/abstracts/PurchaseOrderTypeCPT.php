...
class PurchaseOrderTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_pordertype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_pordertype', 
            array(
                'label' => 'Purchase Order Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Purchase Order Type',
                'edit_item'         => 'Edit Purchase Order Type',
                'new_item'          => 'New Purchase Order Type',
                'view_item'         => 'View Purchase Order Type',
                'search_items'      => 'Search Purchase Order Type',
                'not_found'         => 'No Purchase Order Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Purchase Order Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_pordertype') 
        {
    ...
    public static function sb_pordertype_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_pordertype_table_content($column_name, $post_id){
