...
class PropertyStaffCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_propstaff'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_propstaff', 
            array(
                'label' => 'Property Staff',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Property Staff',
                'edit_item'         => 'Edit Property Staff',
                'new_item'          => 'New Property Staff',
                'view_item'         => 'View Property Staff',
                'search_items'      => 'Search Property Staff',
                'not_found'         => 'No Property Staff Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Property Staff',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_propstaff') 
        {
    ...
    public static function sb_propstaff_table_content($column_name, $post_id){
        if ($column_name == 'entity_code') {
            $field_value = get_post_meta($post_id, 'entity_code', true );
            echo $field_value;
        }
        if ($column_name == 'ps_property') {
            $field_value = get_post_meta($post_id, 'ps_property', true );
            echo $field_value;
        }
        if ($column_name == 'ps_staff') {
            $field_value = get_post_meta($post_id, 'ps_staff', true );
            echo $field_value;
        }
        if ($column_name == 'name') {
