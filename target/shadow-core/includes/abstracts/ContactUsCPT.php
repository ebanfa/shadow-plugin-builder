...
class ContactUsCPT {
    ...
    public static $post_name = 'sb_contactus'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_contactus', 
            array(
                'label' => 'Contact Us',
                'labels' => array(
                'add_new'           => 'Add New',
                ...
                'not_found'         => 'No Contact Us Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Contact Us',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_contactus') 
        {
    ...
    public static function sb_contactus_table_content($column_name, $post_id){
