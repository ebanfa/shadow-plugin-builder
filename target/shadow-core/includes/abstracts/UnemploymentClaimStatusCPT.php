...
class UnemploymentClaimStatusCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_ucstatus'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_ucstatus', 
            array(
                'label' => 'Unemployment Claim Status',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Unemployment Claim Status',
                'edit_item'         => 'Edit Unemployment Claim Status',
                'new_item'          => 'New Unemployment Claim Status',
                'view_item'         => 'View Unemployment Claim Status',
                'search_items'      => 'Search Unemployment Claim Status',
                'not_found'         => 'No Unemployment Claim Status Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Unemployment Claim Status',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_ucstatus_table_head($defaults){
        $defaults['name']  = 'name';
    ...
    public static function sb_ucstatus_table_content($column_name, $post_id){
