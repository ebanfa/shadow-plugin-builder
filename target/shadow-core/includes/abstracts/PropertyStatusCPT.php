...
class PropertyStatusCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_propstatus'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_propstatus', 
            array(
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_propstatus') 
        {
    ...
    public static function sb_propstatus_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_propstatus_table_content($column_name, $post_id){
