...
class SalesDataCPT {
    ...
    public static $post_name = 'sb_salesdata'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_salesdata', 
            array(
                'label' => 'Sales Data',
                'labels' => array(
                'add_new'           => 'Add New',
                ...
                'description' => 'Reusable Sales Data',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_salesdata') 
        {
    ...
    public static function sb_salesdata_table_head($defaults){
        $defaults['name']  = 'Name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_salesdata_table_content($column_name, $post_id){
        if ($column_name == 'entity_code') {
            $field_value = get_post_meta($post_id, 'entity_code', true );
            echo $field_value;
        }
        if ($column_name == 'sd_type') {
            $field_value = get_post_meta($post_id, 'sd_type', true );
            echo $field_value;
        }
        if ($column_name == 'sd_assessment') {
            $field_value = get_post_meta($post_id, 'sd_assessment', true );
            echo $field_value;
        }
        if ($column_name == 'name') {
        ...
        if ($column_name == 'effective_ate') {
            $field_value = get_post_meta($post_id, 'effective_ate', true );
            echo $field_value;
        }
