...
class DeprecationMethodCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_dmethod'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_dmethod', 
            array(
                'label' => 'Depreciation Method',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Depreciation Method',
                'edit_item'         => 'Edit Depreciation Method',
                'new_item'          => 'New Depreciation Method',
                'view_item'         => 'View Depreciation Method',
                'search_items'      => 'Search Depreciation Method',
                'not_found'         => 'No Depreciation Method Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Depreciation Method',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_dmethod_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_dmethod_table_content($column_name, $post_id){
