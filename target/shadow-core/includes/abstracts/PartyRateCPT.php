...
class PartyRateCPT {
    ...
    public static $post_name = 'sb_partyrate'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_partyrate', 
            array(
                'label' => 'Party Rate',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Party Rate',
                'edit_item'         => 'Edit Party Rate',
                'new_item'          => 'New Party Rate',
                'view_item'         => 'View Party Rate',
                'search_items'      => 'Search Party Rate',
                'not_found'         => 'No Party Rate Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Party Rate',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_partyrate') 
        {
    ...
    public static function sb_partyrate_table_head($defaults){
    ...
    public static function sb_partyrate_table_content($column_name, $post_id){
