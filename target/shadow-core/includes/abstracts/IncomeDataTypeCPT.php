...
class IncomeDataTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_idtype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_idtype', 
            array(
                'label' => 'Income Data Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Income Data Type',
                'edit_item'         => 'Edit Income Data Type',
                'new_item'          => 'New Income Data Type',
                'view_item'         => 'View Income Data Type',
                'search_items'      => 'Search Income Data Type',
                'not_found'         => 'No Income Data Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Income Data Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_idtype_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_idtype_table_content($column_name, $post_id){
