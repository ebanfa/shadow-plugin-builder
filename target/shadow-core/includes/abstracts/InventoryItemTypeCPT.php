...
class InventoryItemTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_invitemtype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_invitemtype', 
            array(
                'label' => 'Inventory Item Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Inventory Item Type',
                'edit_item'         => 'Edit Inventory Item Type',
                'new_item'          => 'New Inventory Item Type',
                'view_item'         => 'View Inventory Item Type',
                'search_items'      => 'Search Inventory Item Type',
                'not_found'         => 'No Inventory Item Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Inventory Item Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_invitemtype') 
        {
    ...
    public static function sb_invitemtype_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_invitemtype_table_content($column_name, $post_id){
