...
<?php do_action('shadowbanker_before_app_menu'); ?>
	...
	<ul class="main-menu">
		...
		<li class="sub-menu">
            ...
            <ul>
				<li><a href="/wordpress/page?artifact=productorder&page_action=list&role=customer"><i class="md md-person"></i> Sales Orders</a></li>
				<li><a href="/wordpress/page?artifact=productorder&page_action=list&role=supplier"><i class="md md-person"></i> Purchase Orders</a></li>
				<li><a href="/wordpress/page?artifact=invoice&page_action=list&role=customer"><i class="md md-person"></i> Customer Invoices</a></li>
				<li><a href="/wordpress/page?artifact=invoice&page_action=list&role=supplier"><i class="md md-person"></i> Supplier Invoices</a></li>
				<li><a href="/wordpress/page?artifact=payment&page_action=list&role=customer"><i class="md md-person"></i> Receipts</a></li>
				<li><a href="/wordpress/page?artifact=payment&page_action=list&role=supplier"><i class="md md-person"></i> Disbursements</a></li>
            </ul>
        </li>
		<li class="sub-menu">
            <a href=""><i class="md zmdi zmdi-balance"></i> Accounting</a>
            <ul>
				<li><a href="/wordpress/page?artifact=accounttransaction&page_action=list&role=customer"><i class="md md-person"></i> Sales</a></li>
				<li><a href="/wordpress/page?artifact=accounttransaction&page_action=list&role=supplier"><i class="md md-person"></i> Expenses</a></li>
				<li><a href="/wordpress/page?artifact=transactiondetail&page_action=list"><i class="md md-person"></i> Journal</a></li>
				<li><a href="/wordpress/page?artifact=chartofaccounts&page_action=list"><i class="md md-person"></i> Chart Of Accounts</a></li>
				<li><a href="/wordpress/page?artifact=bankaccount&page_action=list"><i class="md md-person"></i> Bank Accounts</a></li>
            </ul>
        </li>
		<li class="sub-menu">
