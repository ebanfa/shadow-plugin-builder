...
if (!defined('ABSPATH')) {
    ...
    $dashboard_stats = DashboardService::get_admin_dashboard_stats();
?>
                ...
                <div class="mini-charts-item bgm-cyan">
                    <div class="clearfix">
                        ...
                        <div class="count">
                            ...
                            <h2><?php echo $dashboard_stats['customer_count'];?></h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="mini-charts-item bgm-lightgreen">
                    <div class="clearfix">
                        ...
                        <div class="count">
                            ...
                            <h2><?php echo $dashboard_stats['product_count'];?></h2>
                ...
                <div class="mini-charts-item bgm-orange">
                    <div class="clearfix">
                        ...
                        <div class="count">
                            ...
                            <h2><?php echo $dashboard_stats['orders_count'];?></h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="mini-charts-item bgm-bluegray">
                    <div class="clearfix">
                        ...
                        <div class="count">
                            ...
                            <h2><?php echo $dashboard_stats['inventory_count'];?></h2>
                        </div>
                    </div>
                </div>
            </div>
