    ...
    <div class="pm-overview c-overflow">
        <div class="pmo-pic">
            <div class="p-relative">
                ...
                <a href="#modalWider">
                    <img class="img-responsive" src="<?php echo get_stylesheet_directory_uri(); ?>/images/portal/profile-pics/<?php echo $model['image']; ?>" alt=""> 
                </a>
                ...
                <a  href="#modalWider" class="pmop-edit">
