                ...
                'columnDefs': [
                    { "visible": false,  "targets": 0 },
                    {
                        ...
                        "render": function ( data, type, row ) {
                            ...
                            return '<a class="data-table-link" href="' + '<?php echo EntityActionProcessor::get_base_url(); ?>' + 'artifact=<?php echo $view->get_artifact_name(); ?>&id=' + row.id + '&page_action=view' + parent_params + additional_seach_options + '<?php echo $entity_criteria_query; ?>' + '" data-related-artifact-name="<?php echo $view->get_artifact_name(); ?>" data-related-instance-name="' + row.name + '" data-related-instance-id="' + row.id + '">' + data +  '</a>';
                        },
                        "targets": 1
                    }
                ]
