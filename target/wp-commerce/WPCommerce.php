...
class WPCommerce {
    ...
    public function includes() {
        ...
        include_once('includes/abstracts/ProductTemplateCPT.php');
        include_once('includes/abstracts/ProductTemplate.php');
        ...
        include_once('includes/api/ProductTemplateAPI.php');
        ...
        include_once('includes/api/InvoiceItemAPI.php');
        include_once('includes/api/PaymentAPI.php');
        include_once('includes/api/SalesOrderAPI.php');
        include_once('includes/api/ShoppingCartAPI.php');
        ...
        include_once('includes/view/producttemplate/SingleProductTemplateView.php');
    ...
    public function init_admin_template_hooks(){
        ...
        add_filter('manage_sb_producttmpl_posts_columns', 'ProductTemplateCPT::sb_producttmpl_table_head');
        add_action('manage_sb_producttmpl_posts_custom_column', 'ProductTemplateCPT::sb_producttmpl_table_content', 10, 2);
