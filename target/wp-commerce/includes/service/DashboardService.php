...
class DashboardService {
    ...
    public static function get_admin_dashboard_stats(){
        ...
        $customer_count = DashboardService::get_customer_count();
        $product_count =  DashboardService::get_product_count();
        $orders_count = DashboardService::get_orders_count();
        $inventory_count = DashboardService::get_inventory_count();
