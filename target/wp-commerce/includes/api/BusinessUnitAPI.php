...
class BusinessUnitAPI {
    ...
    public static $default_business_unit = 'DEFAULT';
     ...
     * Get current user business role
     */
    public static function get_default_business_unit(){
        $business_unit_data = EntityAPI::get_by_code('businessunit', self::$default_business_unit);
        if(!isset($business_unit_data['id']))
            return EntityAPIUtils::init_error($business_unit_data, 'Default business unit not configured');
