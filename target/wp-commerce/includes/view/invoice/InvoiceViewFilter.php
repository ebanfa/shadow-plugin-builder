...
class InvoiceViewFilter extends CategorizedViewFilter {

    /**
     *
     */
    public static function init_hooks() { 
        add_filter('shadowbanker_invoice_form_fields', array('InvoiceViewFilter', 'filter_form_fields'), 10, 2);
        add_filter('shadowbanker_invoice_action_links', array('InvoiceViewFilter', 'filter_view_action_links'), 10, 2);
    }
