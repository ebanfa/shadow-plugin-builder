...
class FinancialEventTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_feventtype'; 
 ...
 public static $related_child_entities = array(
        ...
        'event_type' => array('name' => 'event_type',
            'entity_name' => 'FinancialEvent',
            'data_type' => 'sb_fevent',
            'artifact_name' => 'financialevent',
            'entity_description' => 'Financial EVent',
            'is_relationship_field' => true,
            'fields' => array(
                'entity_code' => array('name' => 'entity_code',
                    'description' => 'Code',
    ...
    {
       register_post_type('sb_feventtype', 
            array(
                'label' => 'Financial Event Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Financial Event Type',
                'edit_item'         => 'Edit Financial Event Type',
                'new_item'          => 'New Financial Event Type',
                'view_item'         => 'View Financial Event Type',
                'search_items'      => 'Search Financial Event Type',
                'not_found'         => 'No Financial Event Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Financial Event Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_feventtype') 
        {
    ...
    public static function sb_feventtype_table_head($defaults){
    ...
    public static function sb_feventtype_table_content($column_name, $post_id){
