...
class InvoiceTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_invoicetype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_invoicetype', 
            array(
                'label' => 'Invoice Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Invoice Type',
                'edit_item'         => 'Edit Invoice Type',
                'new_item'          => 'New Invoice Type',
                'view_item'         => 'View Invoice Type',
                'search_items'      => 'Search Invoice Type',
                'not_found'         => 'No Invoice Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Invoice Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_invoicetype') 
        {
    ...
    public static function sb_invoicetype_table_head($defaults){
        $defaults['name']  = 'name';
