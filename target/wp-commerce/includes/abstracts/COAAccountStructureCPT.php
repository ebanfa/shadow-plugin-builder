...
class COAAccountStructureCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_coaacctstruct'; 
    ...
    public static $custom_fields =  array(
        ...
        array('name' => 'seg_separator',
            'title' => 'Segment Separator',
            'description' => 'The Segment Separator field',
            'type' => 'text',
        ),
 ...
 public static $entity_fields = array(
        ...
        'name' => array('name' => 'name',
            ...
            'is_form_field' => true,
            'is_relationship_field' => false,),
        'seg_separator' => array('name' => 'seg_separator',
            'description' => 'Segment Separator',
            'nick_name' => 'seg_separator',
            'size' => 'medium',
            'data_type' => 'text',
            'is_required' => true,
            'is_visible' => true,
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_coaacctstruct', 
            array(
                'label' => 'COA Account Structure',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New COA Account Structure',
                'edit_item'         => 'Edit COA Account Structure',
                'new_item'          => 'New COA Account Structure',
                'view_item'         => 'View COA Account Structure',
                'search_items'      => 'Search COA Account Structure',
                'not_found'         => 'No COA Account Structure Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable COA Account Structure',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_coaacctstruct') 
        {
    ...
    public static function sb_coaacctstruct_table_head($defaults){
        $defaults['name']  = 'name';
        $defaults['seg_separator']  = 'Segment Separator';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_coaacctstruct_table_content($column_name, $post_id){
        ...
        if ($column_name == 'seg_separator') {
            $field_value = get_post_meta($post_id, 'seg_separator', true );
            echo $field_value;
        }
