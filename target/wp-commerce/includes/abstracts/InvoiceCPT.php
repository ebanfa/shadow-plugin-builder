...
class InvoiceCPT {
    ...
    public static $custom_fields =  array(
        ...
        array('name' => 'invoice_type',
            'title' => 'Invoice Type',
            'description' => 'The Invoice Type field',
            'type' => 'text',
        ),
        array('name' => 'invoice_owner',
            'title' => 'Invoice Owner',
            'description' => 'The Invoice Owner field',
            'type' => 'text',
        ),
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_invoice_table_content($column_name, $post_id){
        ...
        if ($column_name == 'invoice_type') {
            $field_value = get_post_meta($post_id, 'invoice_type', true );
            echo $field_value;
        }
        if ($column_name == 'invoice_owner') {
            $field_value = get_post_meta($post_id, 'invoice_owner', true );
            echo $field_value;
        }
