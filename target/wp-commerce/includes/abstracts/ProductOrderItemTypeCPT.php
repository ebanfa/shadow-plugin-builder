...
class ProductOrderItemTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_prodorderitype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_prodorderitype', 
            array(
                'label' => 'Product Order Item Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Product Order Item Type',
                'edit_item'         => 'Edit Product Order Item Type',
                'new_item'          => 'New Product Order Item Type',
                'view_item'         => 'View Product Order Item Type',
                'search_items'      => 'Search Product Order Item Type',
                'not_found'         => 'No Product Order Item Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Product Order Item Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_prodorderitype') 
        {
    ...
    public static function sb_prodorderitype_table_head($defaults){
    ...
    public static function sb_prodorderitype_table_content($column_name, $post_id){
