...
class UomCPT {
    ...
    public static $custom_fields =  array(
        ...
        array('name' => 'uom_abbr',
            'title' => 'Abbreviation',
            'description' => 'The Abbreviation field',
            'type' => 'text',
        ),
 ...
 public static $related_child_entities = array(
        'from_uom' => array('name' => 'from_uom',
            'entity_name' => 'UomConversion',
            'data_type' => 'sb_uomconversion',
            'artifact_name' => 'uomconversion',
            'entity_description' => 'Uom Conversion',
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_uom_table_head($defaults){
        ...
        $defaults['name']  = 'Name';
        $defaults['uom_abbr']  = 'Abbreviation';
    ...
    public static function sb_uom_table_content($column_name, $post_id){
        ...
        if ($column_name == 'uom_abbr') {
            $field_value = get_post_meta($post_id, 'uom_abbr', true );
            echo $field_value;
        }
