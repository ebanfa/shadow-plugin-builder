 ...
 public static $related_child_entities = array(
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_prodorderitem_table_head($defaults){
        ...
        $defaults['order_item_total']  = 'Total';
    ...
    public static function sb_prodorderitem_table_content($column_name, $post_id){
        ...
        if ($column_name == 'order_item_total') {
            $field_value = get_post_meta($post_id, 'order_item_total', true );
            echo $field_value;
        }
