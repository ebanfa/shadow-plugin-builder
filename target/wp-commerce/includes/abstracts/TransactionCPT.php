...
class TransactionCPT {
    ...
    public static $custom_fields =  array(
        ...
        array('name' => 'gl_txn_type',
            'title' => 'Type',
            'description' => 'The Type field',
            'type' => 'text',
        ),
        array('name' => 'gl_txn_status',
            'title' => 'Status',
 ...
 public static $related_child_entities = array(
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_transaction_table_head($defaults){
        $defaults['gl_txn_type']  = 'Type';
        $defaults['gl_txn_status']  = 'Status';
        $defaults['name']  = 'name';
    ...
    public static function sb_transaction_table_content($column_name, $post_id){
        ...
        if ($column_name == 'gl_txn_type') {
            $field_value = get_post_meta($post_id, 'gl_txn_type', true );
            echo $field_value;
        }
        if ($column_name == 'gl_txn_status') {
            $field_value = get_post_meta($post_id, 'gl_txn_status', true );
            echo $field_value;
        }
        if ($column_name == 'name') {
