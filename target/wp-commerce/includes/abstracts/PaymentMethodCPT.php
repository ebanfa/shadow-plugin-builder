...
class PaymentMethodCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_paymethod'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_paymethod', 
            array(
                ...
                'new_item'          => 'New Payment Method',
                'view_item'         => 'View Payment Method',
                'search_items'      => 'Search Payment Method',
                'not_found'         => 'No Payment Method Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Payment Method',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_paymethod') 
        {
    ...
    public static function sb_paymethod_table_head($defaults){
    ...
    public static function sb_paymethod_table_content($column_name, $post_id){
