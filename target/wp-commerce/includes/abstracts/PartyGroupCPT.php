...
class PartyGroupCPT {
    ...
    public static $post_name = 'sb_partygroup'; 
 ...
 public static $entity_fields = array(
        ...
        'partygroup_party' => array('name' => 'partygroup_party',
            'description' => 'Party',
            'nick_name' => 'partygroup_party',
            'size' => 'large',
            'entity_name' => 'Party',
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_partygroup', 
            array(
                'label' => 'Party Group',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Party Group',
                'edit_item'         => 'Edit Party Group',
                'new_item'          => 'New Party Group',
                'view_item'         => 'View Party Group',
                'search_items'      => 'Search Party Group',
                'not_found'         => 'No Party Group Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Party Group',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_partygroup') 
        {
    ...
    public static function sb_partygroup_table_head($defaults){
    ...
    public static function sb_partygroup_table_content($column_name, $post_id){
        if ($column_name == 'entity_code') {
            $field_value = get_post_meta($post_id, 'entity_code', true );
            echo $field_value;
        }
        if ($column_name == 'partygroup_party') {
            $field_value = get_post_meta($post_id, 'partygroup_party', true );
            echo $field_value;
        }
