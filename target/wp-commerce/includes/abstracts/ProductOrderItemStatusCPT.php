...
class ProductOrderItemStatusCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_prodorderistatus'; 
 ...
 public static $related_child_entities = array(
        'order_item_status' => array('name' => 'order_item_status',
            ...
            'fields' => array(
                ...
                'order_item_price' => array('name' => 'order_item_price',
                    ...
                    'is_form_field' => true,
                    'is_relationship_field' => false,),
                'order_item_total' => array('name' => 'order_item_total',
                    'description' => 'Total',
                    'size' => 'large',
                    'data_type' => 'money',
                    'is_required' => false,
    ...
    {
       register_post_type('sb_prodorderistatus', 
            array(
                'label' => 'Product Order Item Status',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Product Order Item Status',
                'edit_item'         => 'Edit Product Order Item Status',
                'new_item'          => 'New Product Order Item Status',
                'view_item'         => 'View Product Order Item Status',
                'search_items'      => 'Search Product Order Item Status',
                'not_found'         => 'No Product Order Item Status Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Product Order Item Status',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_prodorderistatus') 
        {
    ...
    public static function sb_prodorderistatus_table_head($defaults){
    ...
    public static function sb_prodorderistatus_table_content($column_name, $post_id){
