...
class ProductOrderTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_prodordertype'; 
 ...
 public static $related_child_entities = array(
        'prod_order_type' => array('name' => 'prod_order_type',
            ...
            'fields' => array(
                ...
                'prod_order_status' => array('name' => 'prod_order_status',
                    ...
                    'is_form_field' => true,
                    'is_relationship_field' => true,),
                'placed_by_party' => array('name' => 'placed_by_party',
    ...
    {
       register_post_type('sb_prodordertype', 
            array(
                'label' => 'Product Order Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Product Order Type',
                'edit_item'         => 'Edit Product Order Type',
                'new_item'          => 'New Product Order Type',
                'view_item'         => 'View Product Order Type',
                'search_items'      => 'Search Product Order Type',
                'not_found'         => 'No Product Order Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Product Order Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_prodordertype') 
        {
    ...
    public static function sb_prodordertype_table_head($defaults){
    ...
    public static function sb_prodordertype_table_content($column_name, $post_id){
