...
class COAAccountSegmentCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_coaacctseg'; 
    ...
    public static $custom_fields =  array(
        ...
        array('name' => 'seg_type',
            'title' => 'Segment Type',
            'description' => 'The Segment Type field',
            'type' => 'text',
        ),
        array('name' => 'seg_acctstruct',
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_coaacctseg', 
            array(
                'label' => 'COA Account Segment',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New COA Account Segment',
                'edit_item'         => 'Edit COA Account Segment',
                'new_item'          => 'New COA Account Segment',
                'view_item'         => 'View COA Account Segment',
                'search_items'      => 'Search COA Account Segment',
                'not_found'         => 'No COA Account Segment Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable COA Account Segment',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_coaacctseg') 
        {
    ...
    public static function sb_coaacctseg_table_head($defaults){
        $defaults['seg_type']  = 'Segment Type';
        $defaults['seg_acctstruct']  = 'Account Structure';
        $defaults['name']  = 'name';
        $defaults['seg_sequence']  = 'Sequence No';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_coaacctseg_table_content($column_name, $post_id){
        if ($column_name == 'entity_code') {
            $field_value = get_post_meta($post_id, 'entity_code', true );
            echo $field_value;
        }
        if ($column_name == 'seg_type') {
            $field_value = get_post_meta($post_id, 'seg_type', true );
            echo $field_value;
        }
        if ($column_name == 'seg_acctstruct') {
            $field_value = get_post_meta($post_id, 'seg_acctstruct', true );
            echo $field_value;
        }
        if ($column_name == 'name') {
        ...
        if ($column_name == 'seg_sequence') {
            $field_value = get_post_meta($post_id, 'seg_sequence', true );
            echo $field_value;
        }
