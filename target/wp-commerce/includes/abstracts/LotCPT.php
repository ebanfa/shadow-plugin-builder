...
class LotCPT {
    ...
    public static $post_name = 'sb_lot'; 
 ...
 public static $related_child_entities = array(
    ...
    public static function register_custom_post_type()
    {
       register_post_type('sb_lot', 
            array(
                ...
                'new_item'          => 'New Lot',
                'view_item'         => 'View Lot',
                'search_items'      => 'Search Lot',
                'not_found'         => 'No Lot Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Lot',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_lot_table_head($defaults){
    ...
    public static function sb_lot_table_content($column_name, $post_id){
