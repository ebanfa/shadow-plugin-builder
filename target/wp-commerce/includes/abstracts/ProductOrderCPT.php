...
class ProductOrderCPT {
    ...
    public static $custom_fields =  array(
        ...
        array('name' => 'sub_total',
            'title' => 'Sub Total',
            'description' => 'The Sub Total field',
            'type' => 'text',
        ),
        array('name' => 'discount',
            'title' => 'Discount',
            'description' => 'The Discount field',
            'type' => 'text',
        ),
        array('name' => 'total',
            'title' => 'Total',
 ...
 public static $related_child_entities = array(
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_prodorder_table_head($defaults){
        ...
        $defaults['placed_by_party']  = 'Placed By';
        $defaults['taken_by_party']  = 'Taken By';
        $defaults['name']  = 'Name';
        $defaults['sub_total']  = 'Sub Total';
    ...
    public static function sb_prodorder_table_content($column_name, $post_id){
        ...
        if ($column_name == 'placed_by_party') {
            $field_value = get_post_meta($post_id, 'placed_by_party', true );
            echo $field_value;
        }
        ...
        if ($column_name == 'sub_total') {
            $field_value = get_post_meta($post_id, 'sub_total', true );
            echo $field_value;
        }
        if ($column_name == 'discount') {
            $field_value = get_post_meta($post_id, 'discount', true );
            echo $field_value;
        }
