...
class InvoiceItemStatusCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_invoiceitemstatus'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_invoiceitemstatus', 
            array(
                'label' => 'Invoice Item Status',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Invoice Item Status',
                'edit_item'         => 'Edit Invoice Item Status',
                'new_item'          => 'New Invoice Item Status',
                'view_item'         => 'View Invoice Item Status',
                'search_items'      => 'Search Invoice Item Status',
                'not_found'         => 'No Invoice Item Status Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Invoice Item Status',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_invoiceitemstatus') 
        {
    ...
    public static function sb_invoiceitemstatus_table_head($defaults){
    ...
    public static function sb_invoiceitemstatus_table_content($column_name, $post_id){
