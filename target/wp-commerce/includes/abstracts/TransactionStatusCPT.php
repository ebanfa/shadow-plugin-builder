...
class TransactionStatusCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_txnstatus'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_txnstatus', 
            array(
                'label' => 'Transaction Status',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Transaction Status',
                'edit_item'         => 'Edit Transaction Status',
                'new_item'          => 'New Transaction Status',
                'view_item'         => 'View Transaction Status',
                'search_items'      => 'Search Transaction Status',
                'not_found'         => 'No Transaction Status Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Transaction Status',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_txnstatus') 
        {
    ...
    public static function sb_txnstatus_table_head($defaults){
    ...
    public static function sb_txnstatus_table_content($column_name, $post_id){
