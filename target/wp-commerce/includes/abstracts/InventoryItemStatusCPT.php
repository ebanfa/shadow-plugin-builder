...
class InventoryItemStatusCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_invitemstat'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_invitemstat', 
            array(
                'label' => 'Inventory Item Status',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Inventory Item Status',
                'edit_item'         => 'Edit Inventory Item Status',
                'new_item'          => 'New Inventory Item Status',
                'view_item'         => 'View Inventory Item Status',
                'search_items'      => 'Search Inventory Item Status',
                'not_found'         => 'No Inventory Item Status Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Inventory Item Status',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_invitemstat') 
        {
    ...
    public static function sb_invitemstat_table_head($defaults){
    ...
    public static function sb_invitemstat_table_content($column_name, $post_id){
