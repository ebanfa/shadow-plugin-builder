...
class InvoiceItemTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_invoiceitemtype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_invoiceitemtype', 
            array(
                'label' => 'Invoice Item Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Invoice Item Type',
                'edit_item'         => 'Edit Invoice Item Type',
                'new_item'          => 'New Invoice Item Type',
                'view_item'         => 'View Invoice Item Type',
                'search_items'      => 'Search Invoice Item Type',
                'not_found'         => 'No Invoice Item Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Invoice Item Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_invoiceitemtype') 
        {
    ...
    public static function sb_invoiceitemtype_table_head($defaults){
    ...
    public static function sb_invoiceitemtype_table_content($column_name, $post_id){
