...
class ContainerCPT {
    ...
    public static $post_name = 'sb_container'; 
    ...
    public static $custom_fields =  array(
        ...
        array('name' => 'container_type',
            'title' => 'Type',
            'description' => 'The Type field',
            'type' => 'text',
        ),
        array('name' => 'container_facility',
            'title' => 'Facility',
 ...
 public static $entity_fields = array(
        ...
        'container_type' => array('name' => 'container_type',
            'description' => 'Type',
            'nick_name' => 'container_type',
            'size' => 'large',
            'entity_name' => 'ContainerType',
            'entity_description' => 'Container Type',
            'data_type' => 'sb_containertype',
            'is_required' => true,
            'is_visible' => true,
        ...
        'container_facility' => array('name' => 'container_facility',
            'description' => 'Facility',
            'nick_name' => 'container_facility',
            'size' => 'large',
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_container', 
            array(
                'label' => 'Container',
                'labels' => array(
                'add_new'           => 'Add New',
                ...
                'search_items'      => 'Search Container',
                'not_found'         => 'No Container Found ',
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_container') 
        {
    ...
    public static function sb_container_table_head($defaults){
        $defaults['container_type']  = 'Type';
        $defaults['container_facility']  = 'Facility';
        $defaults['name']  = 'Name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_container_table_content($column_name, $post_id){
        if ($column_name == 'entity_code') {
            $field_value = get_post_meta($post_id, 'entity_code', true );
            echo $field_value;
        }
        if ($column_name == 'container_type') {
            $field_value = get_post_meta($post_id, 'container_type', true );
            echo $field_value;
        }
        if ($column_name == 'container_facility') {
            $field_value = get_post_meta($post_id, 'container_facility', true );
            echo $field_value;
        }
        if ($column_name == 'name') {
