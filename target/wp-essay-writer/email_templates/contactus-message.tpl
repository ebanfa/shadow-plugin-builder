                    ...
                    <table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
                      ...
                      <tr>
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              <h2 style="color: #fff; font-size: 20px;">Hi,</h2>
                              <br>
                              <p style="color: #fff;">The following message was sent from the website</p>
                              <p style="color: #fff;">Sender: [+email+]</p>
                              <p style="color: #fff;">Subject: [+subject+]</p>
