...
class CustomFieldsUtils
{
	...
	public static function get_custom_fields($content_type)
	{
        ...
        case 'sb_subjectarea':
				...
				break;
        case 'sb_subareaimage':
				$custom_fields = SubjectAreaImageCPT::$custom_fields;
				break;
        case 'sb_subject':
				$custom_fields = SubjectCPT::$custom_fields;
				break;
        case 'sb_writingstyle':
				$custom_fields = WritingStyleCPT::$custom_fields;
				break;
        case 'sb_partyeducation':
				$custom_fields = PartyEducationCPT::$custom_fields;
				break;
        case 'sb_partysubject':
				$custom_fields = PartySubjectCPT::$custom_fields;
				break;
        case 'sb_partyreview':
				$custom_fields = PartyReviewCPT::$custom_fields;
				break;
        case 'sb_classtype':
				$custom_fields = ClassificationTypeCPT::$custom_fields;
				break;
        case 'sb_classification':
				$custom_fields = ClassificationCPT::$custom_fields;
				break;
        case 'sb_contentcat':
        ...
        case 'sb_contentclass':
				$custom_fields = ContentClassificationCPT::$custom_fields;
				break;
        case 'sb_cordertype':
	...
	public static function get_field_value($content_type, $post_id, $field) {
        ...
        case 'sb_subjectarea':
				...
				break;
        case 'sb_subareaimage':
				$field_value = SubjectAreaImageCPT::get_field_value($content_type, $post_id, $field);
				break;
        case 'sb_subject':
				$field_value = SubjectCPT::get_field_value($content_type, $post_id, $field);
				break;
        case 'sb_writingstyle':
				$field_value = WritingStyleCPT::get_field_value($content_type, $post_id, $field);
				break;
        case 'sb_partyeducation':
				$field_value = PartyEducationCPT::get_field_value($content_type, $post_id, $field);
				break;
        case 'sb_partysubject':
				$field_value = PartySubjectCPT::get_field_value($content_type, $post_id, $field);
				break;
        case 'sb_partyreview':
				$field_value = PartyReviewCPT::get_field_value($content_type, $post_id, $field);
				break;
        case 'sb_classtype':
				$field_value = ClassificationTypeCPT::get_field_value($content_type, $post_id, $field);
				break;
        case 'sb_classification':
				$field_value = ClassificationCPT::get_field_value($content_type, $post_id, $field);
				break;
        case 'sb_contentcat':
        ...
        case 'sb_contentfile':
				...
				break;
        case 'sb_contentclass':
				$field_value = ContentClassificationCPT::get_field_value($content_type, $post_id, $field);
				break;
        case 'sb_cordertype':
