...
class ArtifactUtils {
    ...
    public static $artifacts = array(
        ...
        'accountsummary' => array('name' => 'AccountSummary', 'description' => 'Account Summary', 'artifact_type' => 'page'),
        'businesssummary' => array('name' => 'BusinessSummary', 'description' => 'Business Summary', 'artifact_type' => 'page'),
        'profile' => array('name' => 'Profile', 'description' => 'My Profile', 'artifact_type' => 'page'),
        ...
        'tutoreditor' => array('name' => 'TutorEditor', 'description' => 'Tutor Editor', 'artifact_type' => 'page'),
        'tutordisplay' => array('name' => 'TutorDisplay', 'description' => 'Tutor Profile', 'artifact_type' => 'page'),
