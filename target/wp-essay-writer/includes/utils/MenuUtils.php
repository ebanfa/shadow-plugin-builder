...
class MenuUtils {
	...
	public static function remove_toplevel_cpt_menus() {
       ...
       remove_menu_page( 'edit.php?post_type=sb_subareaimage');
       remove_menu_page( 'edit.php?post_type=sb_subject');
       remove_menu_page( 'edit.php?post_type=sb_writingstyle');
       remove_menu_page( 'edit.php?post_type=sb_partyeducation');
       remove_menu_page( 'edit.php?post_type=sb_partysubject');
	 ...
	 * Create Orders post-type sub menu
	 */
	public static function render_sb_subareaimage()
	{
		$url = admin_url().'edit.php?post_type=sb_subareaimage';
		?>
	 	<script>location.href='<?php echo $url;?>';</script>
		<?php
	}
	 ...
	 * Create Orders post-type sub menu
	 */
	public static function render_sb_partyeducation()
	{
		$url = admin_url().'edit.php?post_type=sb_partyeducation';
		?>
	 	<script>location.href='<?php echo $url;?>';</script>
		<?php
	}
	 ...
	 * Create Orders post-type sub menu
	 */
	public static function render_sb_partysubject()
	{
		$url = admin_url().'edit.php?post_type=sb_partysubject';
		?>
	 	<script>location.href='<?php echo $url;?>';</script>
		<?php
	}
