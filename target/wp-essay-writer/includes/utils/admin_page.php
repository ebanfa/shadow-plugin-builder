<div class="wrap">
	...
	<form action="" method="post" id="essay_orders_form">
	    <table class="form-table"> 
			...
			<tr>
				<th scope="row">
					<label for="cp_paypal_id">Price Factor</label>
				</th>
				<td>
					<input id="cp_price_factor" name="cp_price_factor" type="text" size="30" value="<?php echo get_option('cp_price_factor');?>" />
				</td>
			</tr>	
			<tr>
				<th scope="row">
			...
			<tr>
				<th scope="row">
					<label for="cp_default_portal_home_url">Portal Home URL</label>	
				</th>
				<td>	
					<input id="cp_default_portal_home_url" name="cp_default_portal_home_url" type="text" size="50" value="<?php echo get_option('cp_default_portal_home_url');?>" />
				</td>
			</tr>		
			<tr>
				<th scope="row">
