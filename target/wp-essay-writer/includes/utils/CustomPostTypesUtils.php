...
class CustomPostTypesUtils {
	...
	*/
	...
	public static function register_custom_post_type()
	{
        ...
        SubjectAreaImageCPT::register_custom_post_type();
        SubjectCPT::register_custom_post_type();
        WritingStyleCPT::register_custom_post_type();
        PartyEducationCPT::register_custom_post_type();
        PartySubjectCPT::register_custom_post_type();
	...
	public static function save_custom_fields( $post_id, $post ) 
	{
		switch ($post->post_type) 
		{
			...
			case 'sb_subareaimage':
				SubjectAreaImageCPT::save_custom_fields($post_id, $post);
				break;
			case 'sb_subject':
			...
			case 'sb_partyeducation':
				PartyEducationCPT::save_custom_fields($post_id, $post);
				break;
			case 'sb_partysubject':
				PartySubjectCPT::save_custom_fields($post_id, $post);
				break;
			case 'sb_partyreview':
