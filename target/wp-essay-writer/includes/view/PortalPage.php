...
class PortalPage extends AbstractPage { 
    ...
    public function get_create_artifact_url(){
        return ArtifactRequestProcessorUtils::get_create_artifact_url($this->artifact);
    }
    ...
    public function get_list_artifact_url(){
        return ArtifactRequestProcessorUtils::get_list_artifact_url($this->artifact);
    }
    ...
    public function get_artifact_url(){
        return ArtifactRequestProcessorUtils::get_artifact_url($this->artifact);
    }
