...
class PortalPage extends AbstractPage { 
     ...
     * 
     */
    public function get_create_artifact_url(){
        return ArtifactRequestProcessorUtils::get_create_artifact_url($this->get_artifact());
    }
    ...
    public function get_edit_artifact_url(){
        return ArtifactRequestProcessorUtils::get_edit_artifact_url($this->get_artifact());
    }
    ...
    public function get_view_artifact_url(){
        return ArtifactRequestProcessorUtils::get_view_artifact_url($this->get_artifact());
    }

    /**
     * 
     */
    public function get_list_artifact_url(){
        return ArtifactRequestProcessorUtils::get_list_artifact_url($this->get_artifact());
    }
    ...
    public function get_artifact_url(){
        return ArtifactRequestProcessorUtils::get_artifact_url($this->get_artifact());
    }
    ...
    public function get_action_links(){
        return PageUtils::get_action_links($this->page_action, $this->get_artifact());
    }
}
?>