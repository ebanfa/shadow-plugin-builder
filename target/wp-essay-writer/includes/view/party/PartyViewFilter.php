    ...
    public static function filter_view_action_links($view, $action_links) {
        ...
        if($page_action == 'create' || $page_action == 'edit') {
            ...
            $action_links['list_entity_link'] = array('name' => 'View All', 
                'link' => ArtficatAjaxRequestProcessorUtils::get_base_url() . 'page_action=list&artifact=party'. $party_role_param);
        }
        if($page_action == 'list') {
            // Add Person link
            ...
            $action_links['create_person_link'] = array('name' => 'Add New Person', 
                'link' => ArtficatAjaxRequestProcessorUtils::get_base_url() . 'page_action=create&artifact=person' . $party_role_param);
