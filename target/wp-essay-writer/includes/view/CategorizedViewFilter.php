    ...
    public static function filter_create_view_action_links($view, $action_links) {
        ...
        if(isset($_REQUEST['bcat'])) {
            ...
            $action_links['list_entity_link'] = array('name' => 'View All', 
                'link' => ArtficatAjaxRequestProcessorUtils::get_base_url() . 'artifact=' . $model['entity_artifact_name'] . '&page_action=list' . $business_category);
        }
        return $action_links;
    }
    ...
    public static function filter_view_view_action_links($view, $action_links) {
        ...
        if(isset($business_category_data['id'])) {
            ...
            foreach ($entity_types as $key => $type) {
                ...
                'link' => ArtficatAjaxRequestProcessorUtils::get_base_url() . 
            ...
            $action_links['list_entity_link'] = array('name' => 'View All', 
                'link' => ArtficatAjaxRequestProcessorUtils::get_base_url() . 'artifact=' . $model['entity_artifact_name'] . '&page_action=list&bcat=' . strtolower($business_category_data['entity_code']));
        }
        return $action_links;
    }
