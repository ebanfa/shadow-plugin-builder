...
class URLRewriteProcessor {
    ...
    public static function add_url_rewrite_rules() {
        ...
        add_rewrite_rule('^portal/([^/]*[signin])$', 'index.php?pagename=content-page&page_type=portal&artifact=signin&page_action=list&role=$matches[1]', 'top' );
        add_rewrite_rule('^portal/([^/]*[signup])$', 'index.php?pagename=content-page&page_type=portal&artifact=signup&page_action=list&role=$matches[1]', 'top' );
        add_rewrite_rule('^portal/([^/]*[password])$', 'index.php?pagename=content-page&page_type=portal&artifact=password&page_action=list&role=$matches[1]', 'top' );
        ...
        add_rewrite_rule('^portal/([^/]*)/view/([0-9a-zA-Z]*)$', 'index.php?pagename=content-page&page_type=portal&artifact=$matches[1]&page_action=view&entity_id=$matches[2]', 'top' );
        add_rewrite_rule('^portal/([^/]*)/edit/([0-9a-zA-Z]*)$', 'index.php?pagename=content-page&page_type=portal&artifact=$matches[1]&page_action=edit&entity_id=$matches[2]', 'top' );
