...
class AccountTransactionCPT {
    ...
    public static $custom_fields =  array(
        ...
        array('name' => 'billing_account',
            'title' => 'Billing Account',
            'description' => 'The Billing Account field',
            'type' => 'text',
        ),
        array('name' => 'transaction_order',
            'title' => 'Content Order',
        ...
        array('name' => 'db_cr_fg',
            'title' => 'Debit/Credit',
            'description' => 'The Debit/Credit field',
            'type' => 'text',
        ),
 ...
 public static $related_child_entities = array(
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_accttransaction_table_head($defaults){
        ...
        $defaults['billing_account']  = 'Billing Account';
        $defaults['transaction_order']  = 'Content Order';
        $defaults['amount']  = 'Amount';
        $defaults['db_cr_fg']  = 'Debit/Credit';
    ...
    public static function sb_accttransaction_table_content($column_name, $post_id){
        ...
        if ($column_name == 'billing_account') {
            $field_value = get_post_meta($post_id, 'billing_account', true );
            echo $field_value;
        }
        if ($column_name == 'transaction_order') {
            $field_value = get_post_meta($post_id, 'transaction_order', true );
            echo $field_value;
        }
