...
class ContentTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_contenttype'; 
 ...
 public static $entity_fields = array(
        ...
        'content_category' => array('name' => 'content_category',
            'description' => 'Category',
            'nick_name' => 'content_category',
            'size' => 'large',
            'entity_name' => 'ContentCategory',
            'entity_description' => 'Content Category',
            'data_type' => 'sb_contentcat',
            'is_required' => true,
            'is_visible' => true,
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_contenttype', 
            array(
                'label' => 'Content Type',
                'labels' => array(
                'add_new'           => 'Add New',
                ...
                'new_item'          => 'New Content Type',
                'view_item'         => 'View Content Type',
                'search_items'      => 'Search Content Type',
                'not_found'         => 'No Content Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Content Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_contenttype') 
        {
    ...
    public static function sb_contenttype_table_head($defaults){
        $defaults['content_category']  = 'Category';
        $defaults['name']  = 'Name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_contenttype_table_content($column_name, $post_id){
        if ($column_name == 'entity_code') {
            $field_value = get_post_meta($post_id, 'entity_code', true );
            echo $field_value;
        }
        if ($column_name == 'content_category') {
            $field_value = get_post_meta($post_id, 'content_category', true );
            echo $field_value;
        }
        if ($column_name == 'name') {
