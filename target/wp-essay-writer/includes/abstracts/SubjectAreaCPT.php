...
class SubjectAreaCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_subjectarea'; 
 ...
 public static $related_child_entities = array(
        ...
        'target_subject_area' => array('name' => 'target_subject_area',
            'entity_name' => 'PartySubjectArea',
            'data_type' => 'sb_partysubarea',
            'artifact_name' => 'partysubjectarea',
            'entity_description' => 'Party Subject Area',
            'is_relationship_field' => true,
            'fields' => array(
                'entity_code' => array('name' => 'entity_code',
                    'description' => 'Code',
    ...
    {
       register_post_type('sb_subjectarea', 
            array(
                'label' => 'Subject Area',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Subject Area',
                'edit_item'         => 'Edit Subject Area',
                'new_item'          => 'New Subject Area',
                'view_item'         => 'View Subject Area',
                'search_items'      => 'Search Subject Area',
                'not_found'         => 'No Subject Area Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Subject Area',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_subjectarea') 
        {
    ...
    public static function sb_subjectarea_table_head($defaults){
        $defaults['name']  = 'Name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_subjectarea_table_content($column_name, $post_id){
