...
class NoOfPagesCPT {
    ...
    public static $post_name = 'sb_noofpages'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_noofpages', 
            array(
                'label' => 'No Of Pages',
                'labels' => array(
                'add_new'           => 'Add New',
                ...
                'search_items'      => 'Search No Of Pages',
                'not_found'         => 'No No Of Pages Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable No Of Pages',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_noofpages') 
        {
    ...
    public static function sb_noofpages_table_head($defaults){
        $defaults['name']  = 'Name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_noofpages_table_content($column_name, $post_id){
