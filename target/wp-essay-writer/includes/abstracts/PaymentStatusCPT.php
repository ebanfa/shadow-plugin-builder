...
class PaymentStatusCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_paymentstatus'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_paymentstatus', 
            array(
                'label' => 'Payment Status',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Payment Status',
                'edit_item'         => 'Edit Payment Status',
                'new_item'          => 'New Payment Status',
                'view_item'         => 'View Payment Status',
                'search_items'      => 'Search Payment Status',
                'not_found'         => 'No Payment Status Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Payment Status',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_paymentstatus') 
        {
    ...
    public static function sb_paymentstatus_table_head($defaults){
        $defaults['name']  = 'Name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_paymentstatus_table_content($column_name, $post_id){
