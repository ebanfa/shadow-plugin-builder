...
class WritingStyleCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_writingstyle'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_writingstyle', 
            array(
                'label' => 'Writing Style',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Writing Style',
                'edit_item'         => 'Edit Writing Style',
                'new_item'          => 'New Writing Style',
                'view_item'         => 'View Writing Style',
                'search_items'      => 'Search Writing Style',
                'not_found'         => 'No Writing Style Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Writing Style',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_writingstyle') 
        {
    ...
    public static function sb_writingstyle_table_head($defaults){
        $defaults['name']  = 'Name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_writingstyle_table_content($column_name, $post_id){
