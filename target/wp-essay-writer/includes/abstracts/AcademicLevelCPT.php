...
class AcademicLevelCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_academiclevel'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_academiclevel', 
            array(
                ...
                'search_items'      => 'Search Academic Level',
                'not_found'         => 'No Academic Level Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Academic Level',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_academiclevel') 
        {
    ...
    public static function sb_academiclevel_table_head($defaults){
        $defaults['name']  = 'Name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_academiclevel_table_content($column_name, $post_id){
