...
class ContentOrderStatusCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_corderstatus'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_corderstatus', 
            array(
                'label' => 'Content Order Status',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Content Order Status',
                'edit_item'         => 'Edit Content Order Status',
                'new_item'          => 'New Content Order Status',
                'view_item'         => 'View Content Order Status',
                'search_items'      => 'Search Content Order Status',
                'not_found'         => 'No Content Order Status Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Content Order Status',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_corderstatus') 
        {
    ...
    public static function sb_corderstatus_table_head($defaults){
        $defaults['name']  = 'Name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_corderstatus_table_content($column_name, $post_id){
