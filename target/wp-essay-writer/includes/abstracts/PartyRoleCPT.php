...
class PartyRoleCPT {
    ...
    public static $custom_fields =  array(
        ...
        array('name' => 'party_role_party',
            'title' => 'Party',
            'description' => 'The Party field',
            'type' => 'text',
        ),
        array('name' => 'party_role_type',
            'title' => 'Role',
 ...
 public static $related_child_entities = array(
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_partyrole_table_head($defaults){
        $defaults['party_role_party']  = 'Party';
        $defaults['party_role_type']  = 'Role';
        $defaults['name']  = 'Name';
    ...
    public static function sb_partyrole_table_content($column_name, $post_id){
        ...
        if ($column_name == 'party_role_party') {
            $field_value = get_post_meta($post_id, 'party_role_party', true );
            echo $field_value;
        }
        if ($column_name == 'party_role_type') {
            $field_value = get_post_meta($post_id, 'party_role_type', true );
            echo $field_value;
        }
        if ($column_name == 'name') {
