...
class SubjectCPT {
    ...
    public static $post_name = 'sb_subject'; 
 ...
 public static $related_child_entities = array(
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_subject_table_head($defaults){
        $defaults['parent_area']  = 'Subject Area';
        $defaults['name']  = 'Name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_subject_table_content($column_name, $post_id){
        if ($column_name == 'parent_area') {
            $field_value = get_post_meta($post_id, 'parent_area', true );
            echo $field_value;
        }
