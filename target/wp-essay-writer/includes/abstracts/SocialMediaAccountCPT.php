...
class SocialMediaAccountCPT {
    ...
    public static $custom_fields =  array(
        ...
        array('name' => 'token_id',
            'title' => 'Token ID',
            'description' => 'The Token ID field',
            'type' => 'text',
        ),
        array('name' => 'token_code',
            'title' => 'Token Code',
            'description' => 'The Token Code field',
            'type' => 'text',
        ),
        array('name' => 'password',
            'title' => 'Password',
 ...
 public static $related_child_entities = array(
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_socmediaacct_table_head($defaults){
        ...
        $defaults['token_code']  = 'Token Code';
    ...
    public static function sb_socmediaacct_table_content($column_name, $post_id){
        ...
        if ($column_name == 'token_id') {
            $field_value = get_post_meta($post_id, 'token_id', true );
            echo $field_value;
        }
        if ($column_name == 'token_code') {
            $field_value = get_post_meta($post_id, 'token_code', true );
            echo $field_value;
        }
