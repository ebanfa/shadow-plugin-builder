...
class ContentOrderTypeCPT {

    public static $prefix = ''; 

    public static $post_name = 'sb_cordertype'; 
 ...
 public static $related_child_entities = array(
    ...
    {
       register_post_type('sb_cordertype', 
            array(
                'label' => 'Content Order Type',
                'labels' => array(
                'add_new'           => 'Add New',
                'add_new_item'      => 'Add New Content Order Type',
                'edit_item'         => 'Edit Content Order Type',
                'new_item'          => 'New Content Order Type',
                'view_item'         => 'View Content Order Type',
                'search_items'      => 'Search Content Order Type',
                'not_found'         => 'No Content Order Type Found ',
                'not_found_in_trash'=> 'Not Found in Trash',
                ),
                'description' => 'Reusable Content Order Type',
                'public' => true,
                'show_ui' => true,
                'menu_position' => 5,
  ...
  ------------------------------------------------------------------------------*/
    ...
    {
        if ( $post->post_type == 'sb_cordertype') 
        {
    ...
    public static function sb_cordertype_table_head($defaults){
        $defaults['name']  = 'Name';
        $defaults['description']  = 'Description';
        return $defaults;
    }

    public static function sb_cordertype_table_content($column_name, $post_id){
