...
class ContentCPT {
    ...
    public static $custom_fields =  array(
        ...
        array('name' => 'content_party',
            'title' => 'Owner',
            'description' => 'The Owner field',
            'type' => 'text',
        ),
        array('name' => 'content_tutor',
            'title' => 'Tutor',
 ...
 public static $related_child_entities = array(
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_content_table_head($defaults){
        ...
        $defaults['content_party']  = 'Owner';
        $defaults['content_tutor']  = 'Tutor';
    ...
    public static function sb_content_table_content($column_name, $post_id){
        ...
        if ($column_name == 'content_party') {
            $field_value = get_post_meta($post_id, 'content_party', true );
            echo $field_value;
        }
        if ($column_name == 'content_tutor') {
            $field_value = get_post_meta($post_id, 'content_tutor', true );
            echo $field_value;
        }
        if ($column_name == 'content_subject') {
            $field_value = get_post_meta($post_id, 'content_subject', true );
            echo $field_value;
        }
        if ($column_name == 'name') {
