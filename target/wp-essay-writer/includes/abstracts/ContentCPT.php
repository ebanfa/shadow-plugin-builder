...
class ContentCPT {
    ...
    public static $post_name = 'sb_content'; 
 ...
 public static $related_child_entities = array(
        'file_of_content' => array('name' => 'file_of_content',
            'entity_name' => 'ContentFile',
            'data_type' => 'sb_contentfile',
            'artifact_name' => 'contentfile',
            'entity_description' => 'Content File',
            'is_relationship_field' => true,
            'fields' => array(
                'entity_code' => array('name' => 'entity_code',
                    'description' => 'Code',
  ...
  ------------------------------------------------------------------------------*/
    ...
    public static function sb_content_table_head($defaults){
    ...
    public static function sb_content_table_content($column_name, $post_id){
        if ($column_name == 'entity_code') {
            $field_value = get_post_meta($post_id, 'entity_code', true );
            echo $field_value;
        }
        if ($column_name == 'content_type') {
            $field_value = get_post_meta($post_id, 'content_type', true );
            echo $field_value;
        }
        ...
        if ($column_name == 'title') {
            $field_value = get_post_meta($post_id, 'title', true );
            echo $field_value;
        }
