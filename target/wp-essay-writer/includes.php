<?php
	...
	// View
    include_once('includes/view/party/ViewPartyPage.php');
    include_once('includes/view/party/ViewPartyPageModel.php');
    include_once('includes/view/party/ListPartyPage.php');
    include_once('includes/view/party/ListPartyPageModel.php');
    include_once('includes/view/contentorder/CreateContentOrderPage.php');
    include_once('includes/view/contentorder/CreateContentOrderPageModel.php');
    include_once('includes/view/contentorder/EditContentOrderPage.php');
    include_once('includes/view/contentorder/EditContentOrderPageModel.php');
    include_once('includes/view/contentorder/ViewContentOrderPage.php');
    include_once('includes/view/contentorder/ViewContentOrderPageModel.php');
	// Pages
        ...
        include_once('includes/view/StudentDisplayPageModel.php');
        include_once('includes/view/StudentEditorPage.php');
        include_once('includes/view/StudentEditorPageModel.php');
        include_once('includes/view/TutorListPage.php');
        include_once('includes/view/TutorListPageModel.php');
        include_once('includes/view/TutorDisplayPage.php');
