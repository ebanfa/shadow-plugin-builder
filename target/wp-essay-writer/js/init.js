...
(function (BlitzDocument, $, undefined) {
    ...
    BlitzDocument.doOrderFormCalculation = function () {
        ...
        var priceFactor = wpessaywriter_ajax_script.factor;

        var discount = orderForm.discount_percent_h.value;
        var wthdy = '';
        var wthdyx = '';
        var oc = priceFactor * doTypeOfDocumentCost(orderForm.document_type) * doAcademicLevelCost(orderForm.academic_level) * doUrgencyCost(orderForm.urgency) * doSubjectAreaCost(orderForm.subject);
