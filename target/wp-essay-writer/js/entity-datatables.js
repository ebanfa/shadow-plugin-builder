...
jQuery(document).ready(function($)
{
    ...
    $('#sb_subareaimage-table').dataTable({
        "ajax": {
            'type': 'POST',
            'url': wpessaywriter_ajax_script.ajaxurl,
            'data': function(d){
               d.action = 'find_entity_ajax';
               d.artifact = 'subjectareaimage';
               d.form = $("#sb_subareaimage-list-form").serializeArray();
            },
        },
        columns: [
            { data: "id" }, 
        ...
        columnDefs: [
            { "visible": false,  "targets": 0 },
            {
                ...
                "render": function ( data, type, row ) {
                    ...
                    return '<a class="data-table-link" href="' + baseUrl + 'artifact=subjectareaimage&id=' + row.id + '&page_action=view' + parent_params + '" data-related-artifact-name="subjectareaimage" data-related-instance-name="' + row.name + '" data-related-instance-id="' + row.id + '">' + data +  '</a>';
                },
                "targets": 1
            }
        ]
    ...
    $('#sb_subject-table').dataTable({
        "ajax": {
            ...
            'data': function(d){
               d.action = 'find_entity_ajax';
               d.artifact = 'subject';
               d.form = $("#sb_subject-list-form").serializeArray();
            },
        },
        columns: [
            { data: "id" }, 
        ...
        columnDefs: [
            { "visible": false,  "targets": 0 },
            {
                ...
                "render": function ( data, type, row ) {
                    ...
                    return '<a class="data-table-link" href="' + baseUrl + 'artifact=subject&id=' + row.id + '&page_action=view' + parent_params + '" data-related-artifact-name="subject" data-related-instance-name="' + row.name + '" data-related-instance-id="' + row.id + '">' + data +  '</a>';
                },
                "targets": 1
            }
        ]
    ...
    $('#sb_partyeducation-table').dataTable({
        "ajax": {
            'type': 'POST',
            'url': wpessaywriter_ajax_script.ajaxurl,
            'data': function(d){
               d.action = 'find_entity_ajax';
               d.artifact = 'partyeducation';
               d.form = $("#sb_partyeducation-list-form").serializeArray();
            },
        },
        columns: [
            { data: "id" }, 
        ...
        columnDefs: [
            { "visible": false,  "targets": 0 },
            {
                ...
                "render": function ( data, type, row ) {
                    ...
                    return '<a class="data-table-link" href="' + baseUrl + 'artifact=partyeducation&id=' + row.id + '&page_action=view' + parent_params + '" data-related-artifact-name="partyeducation" data-related-instance-name="' + row.name + '" data-related-instance-id="' + row.id + '">' + data +  '</a>';
                },
                "targets": 1
            }
        ]
    ...
    $('#sb_partysubject-table').dataTable({
        "ajax": {
            'type': 'POST',
            'url': wpessaywriter_ajax_script.ajaxurl,
            'data': function(d){
               d.action = 'find_entity_ajax';
               d.artifact = 'partysubject';
               d.form = $("#sb_partysubject-list-form").serializeArray();
            },
        },
        columns: [
            { data: "id" }, 
        ...
        columnDefs: [
            { "visible": false,  "targets": 0 },
            {
                ...
                "render": function ( data, type, row ) {
                    ...
                    return '<a class="data-table-link" href="' + baseUrl + 'artifact=partysubject&id=' + row.id + '&page_action=view' + parent_params + '" data-related-artifact-name="partysubject" data-related-instance-name="' + row.name + '" data-related-instance-id="' + row.id + '">' + data +  '</a>';
                },
                "targets": 1
            }
        ]
    ...
    $('#sb_classtype-table').dataTable({
        "ajax": {
            'type': 'POST',
            'url': wpessaywriter_ajax_script.ajaxurl,
            'data': function(d){
               d.action = 'find_entity_ajax';
               d.artifact = 'classificationtype';
               d.form = $("#sb_classtype-list-form").serializeArray();
            },
        },
        columns: [
            { data: "id" }, 
        ...
        columnDefs: [
            { "visible": false,  "targets": 0 },
            {
                ...
                "render": function ( data, type, row ) {
                    ...
                    return '<a class="data-table-link" href="' + baseUrl + 'artifact=classificationtype&id=' + row.id + '&page_action=view' + parent_params + '" data-related-artifact-name="classificationtype" data-related-instance-name="' + row.name + '" data-related-instance-id="' + row.id + '">' + data +  '</a>';
                },
                "targets": 1
            }
        ]
    ...
    $('#sb_classification-table').dataTable({
        "ajax": {
            'type': 'POST',
            'url': wpessaywriter_ajax_script.ajaxurl,
            'data': function(d){
               d.action = 'find_entity_ajax';
               d.artifact = 'classification';
               d.form = $("#sb_classification-list-form").serializeArray();
            },
        },
        columns: [
            { data: "id" }, 
        ...
        columnDefs: [
            { "visible": false,  "targets": 0 },
            {
                ...
                "render": function ( data, type, row ) {
                    ...
                    return '<a class="data-table-link" href="' + baseUrl + 'artifact=classification&id=' + row.id + '&page_action=view' + parent_params + '" data-related-artifact-name="classification" data-related-instance-name="' + row.name + '" data-related-instance-id="' + row.id + '">' + data +  '</a>';
                },
                "targets": 1
            }
        ]
    ...
    $('#sb_contentclass-table').dataTable({
        "ajax": {
            'type': 'POST',
            'url': wpessaywriter_ajax_script.ajaxurl,
            'data': function(d){
               d.action = 'find_entity_ajax';
               d.artifact = 'contentclassification';
               d.form = $("#sb_contentclass-list-form").serializeArray();
            },
        },
        columns: [
            { data: "id" }, 
        ...
        columnDefs: [
            { "visible": false,  "targets": 0 },
            {
                ...
                "render": function ( data, type, row ) {
                    ...
                    return '<a class="data-table-link" href="' + baseUrl + 'artifact=contentclassification&id=' + row.id + '&page_action=view' + parent_params + '" data-related-artifact-name="contentclassification" data-related-instance-name="' + row.name + '" data-related-instance-id="' + row.id + '">' + data +  '</a>';
                },
                "targets": 1
            }
        ]
