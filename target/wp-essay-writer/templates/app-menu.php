...
if (is_user_logged_in()) {
        ...
        $menu_groups = array(
        	'peoples' => array(
        		...
        		'items' => array(
        			'students' => array(
		        		'target' => '/wordpress/page?artifact=party&page_action=list&role=student',
		        		'css_class' => 'md-person',
		        		'display_name' => 'Students',
        			),
        			'tutors' => array(
		        		'target' => '/wordpress/page?artifact=party&page_action=list&role=tutor',
		        		'css_class' => 'md-person',
		        		'display_name' => 'Tutors',
        			),
        		),
        	...
        	'content' => array(
        		...
        		'items' => array(
        			'documents' => array(
		        		'target' => '/wordpress/page?artifact=content&page_action=list',
		        		'css_class' => 'md-person',
        	...
        	'accountsummary' => array(
	        	'type' => 'menu',
	        	'target' => '/wordpress/page?artifact=billingaccount&page_action=list',
	        	'is_admin' => false,
