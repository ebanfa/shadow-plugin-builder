...
?>
    ...
    if(isset($_REQUEST['qid'])) {
        $post_id = sanitize_text_field($_REQUEST['qid']);
        // 2. Load the post from the databases
        $post = get_post($post_id);
        $post_data['id'] = $post_id;
        $post_data['title'] = $post->post_title;
        // 3. Display the post title in the form if present
    }
...
<form role="form" name="<?php echo $model['entity_post_name'];?>_form" 
            ...
            <div class="form-group">
                <div class="fg-line">
                    <input type="text" 
                        ...
                        id="name" name="name" value="<?php if(isset($post_data['title'])){ echo $post_data['title'];}?>" 
    ...
    <div class="btn-demo m-t-10">
        ...
        <input type="hidden" name="post_question" value="<?php echo $post_data['id']; ?>" />
        <?php } ?>  
