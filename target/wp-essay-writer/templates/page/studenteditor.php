            ...
            <div class="form-group">
                <div class="fg-line">
                    <input type="text" 
                        ...
                        id="first_name" name="first_name" value="<?php if(isset($student_data['id'])) echo $student_data['first_name'];?>" 
        ...
        <div class="col-xs-12 col-md-6">
            <div class="form-group">
                <div class="fg-line">
                    <input type="text" 
                        class="form-control name" 
                        id="last_name" name="last_name" value="<?php if(isset($student_data['id'])) echo $student_data['last_name'];?>" 
        ...
        <div class="col-xs-12 col-md-6">
            <div class="form-group">
                <div class="fg-line">
                    <input type="text" 
                        class="form-control name" 
                        id="display_name" name="display_name" value="<?php if(isset($student_data['id'])) echo $student_data['display_name'];?>" 
        ...
        <div class="col-xs-12 col-md-6">
            <div class="form-group">
                <div class="fg-line">
                    <input type="email" 
                        class="form-control name" 
                        id="email" name="email" value="<?php if(isset($student_data['id'])) echo $student_data['user_name'];?>" 
                        ...
                        <?php if(isset($student_data['id'])) echo 'disabled';?>>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="form-group">
                <div class="fg-line">
                    <textarea name="description" class="form-control" 
                        ...
                        <?php if(isset($student_data['id'])) echo $student_data['description'];?>
                    </textarea>
                </div>
            </div>
        </div>
