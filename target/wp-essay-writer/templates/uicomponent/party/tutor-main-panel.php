...
<div class="pm-body clearfix">
    ...
    <div class="tab-content p-20">
        <div role="tabpanel" class="tab-pane animated fadeIn in active" id="tab-about">
            ...
            <?php do_action('shadowbanker_do_render_component', 'tutor-buttons-panel'); ?>
        </div> <!-- End tab -->
        <?php do_action('shadowbanker_do_render_component', 'tutor-education-panel'); ?>
        <?php do_action('shadowbanker_do_render_component', 'tutor-subjects-panel'); ?>
...
<?php do_action('shadowbanker_do_render_component', 'tutor-education-modal'); ?>
<?php do_action('shadowbanker_do_render_component', 'tutor-subjects-modal'); ?>
