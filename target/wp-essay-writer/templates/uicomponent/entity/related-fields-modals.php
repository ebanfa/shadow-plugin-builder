...
<?php   foreach ($view->get_artifact_fields() as $field) {
                        ...
                        <ul class="actions actions-alt">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li>
                                        <a href="<?php echo ArtficatAjaxRequestProcessorUtils::get_base_url() ;?>artifact=<?php echo strtolower($field['entity_name']); ?>&page_action=create">Add a new record</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
