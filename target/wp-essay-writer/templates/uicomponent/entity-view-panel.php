                ...
                <div class="tab-content p-20">
                    <div role="tabpanel" class="tab-pane animated fadeIn in active" id="tab-0">
                        ...
                        <div class="btn-demo m-t-10">
                            <a href="<?php echo $view->get_edit_artifact_url(); ?>" class="btn btn-primary waves-effect">
                                ...
                                'columnDefs': [
                                    { "visible": false,  "targets": 0 },
                                    {
                                        ...
                                        "render": function ( data, type, row ) {
                                            ...
                                            return '<a class="data-table-link" href="' + '<?php echo ArtficatAjaxRequestProcessorUtils::get_base_url(); ?>' + 'artifact=<?php echo strtolower($tab['model']['entity_name']); ?>&id=' + row.id + '&page_action=view' +  additional_seach_options +'&parent_id=<?php echo $model['id']; ?>&parent_artifact=<?php echo $view->get_artifact(); ?>&parent_field=<?php echo $child_field_name; ?>" data-related-artifact-name="<?php echo strtolower($tab['model']['entity_name']); ?>" data-related-instance-name="' + row.name + '" data-related-instance-id="' + row.id + '">' + data +  '</a>';
                                        },
                                        "targets": 1
                                    }
                                ]
