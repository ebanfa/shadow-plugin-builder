...
<form role="form" name="<?php echo $model['entity_post_name'];?>_form" 
            ...
            <div class="form-group">
                <div class="fg-line">
                    <input type="text" 
                        ...
                        id="name" name="name" value="<?php echo $model['name'];?>"
        ...
        <div class="col-xs-12 col-md-6">
            <div class="form-group">
                <select class="form-control price_component" name="document_type" >
                    <?php 
                        $document_types = EntityAPI::find_by_criteria('contenttype', array('content_category' => 2));
                        $saved_doc_type = $model['document_type'];
                        foreach ($document_types as $document_type) { ?>
                        <option value="<?php echo $document_type['id']; ?>" <?php if ($saved_doc_type == $document_type['id']) echo "selected='selected'";?>>
        ...
        <div class="col-xs-12 col-md-6">
            <div class="form-group">
                <select class="form-control price_component" name="urgency" >
                    <?php 
                        $urgencies = EntityAPI::find_by_criteria('urgency', array());
                        $saved_urgency = $model['urgency'];
                        foreach ($urgencies as $urgency) { ?>
                        <option value="<?php echo $urgency['id']; ?>" <?php if ($saved_urgency == $urgency['id']) echo "selected='selected'";?>>
            ...
            <div class="form-group">
                <select class="form-control price_component" name="numpages" >
                    <?php
                        ...
                        $saved_noofpage = $model['numpages'];
                        foreach ($noofpages as $noofpage) { ?>
                        <option value="<?php echo $noofpage['id']; ?>" <?php if ($saved_noofpage == $noofpage['id']) echo "selected='selected'";?>>
            ...
            <div class="form-group">
                <select class="form-control price_component" name="academic_level" >
                    <?php
                        ...
                        $saved_academiclevel = $model['academic_level'];
                        foreach ($academiclevels as $academiclevel) { ?>
                            <option value="<?php echo $academiclevel['id']; ?>" <?php if ($saved_academiclevel == $academiclevel['id']) echo "selected='selected'";?>>
            ...
            <div class="form-group">
                <select class="form-control price_component" name="subject" >
                    <?php
                        ...
                        $saved_subject = $model['subject'];
                        foreach ($subjects as $subject) { ?>
                            <option value="<?php echo $subject['id']; ?>" <?php if ($saved_subject == $subject['id']) echo "selected='selected'";?>>
            ...
            <div class="form-group">
                <select class="form-control price_component" name="writing_style" >
                    <?php
                        ...
                        $saved_style = $model['writing_style'];
                        foreach ($styles as $style) { ?>
                            <option value="<?php echo $style['id']; ?>" <?php if ($saved_style == $style['id']) echo "selected='selected'";?>>
                                <?php echo $style['name']; ?>
                            </option>
                    <?php } ?>
                </select>
    ...
    <div class="btn-demo m-t-10">
        ...
        <a href="javascript:void(0);" data-link="<?php echo $view->get_view_artifact_url(); ?>" class="data-table-link btn bgm-indigo waves-effect">
            <?php _e('Back', 'framework') ?>
        </a>
    </div>
