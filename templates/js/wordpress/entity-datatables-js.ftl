        ...
        columnDefs: [
            { "visible": false,  "targets": 0 },
            {
                ...
                "render": function ( data, type, row ) {
                    ...
                    return '<a class="data-table-link" href="../page/?type=entity&artifact=${entity.name?lower_case}&id=' + row.id + role + '&page_action=view' + '" data-related-entity-name="${entity.name?lower_case}" data-related-entity-id="${entity.name?lower_case}">' + data +  '</a>';
                },
                "targets": 1
            }
        ]
