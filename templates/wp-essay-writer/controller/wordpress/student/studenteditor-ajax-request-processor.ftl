...
class StudentEditorAjaxRequestProcessor {
    ...
    public static function create_entity_ajax() {
        ...
        $user_party_data['redirect_url'] = ArtficatAjaxRequestProcessorUtils::get_base_url() . 'artifact=studentdisplay'.'&id='.$user_party_data['id'].'&page_action=view';
