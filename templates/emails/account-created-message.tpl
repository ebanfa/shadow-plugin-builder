                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              ...
                              <br>
                              <p style="color: #fff;">Your account has been created and you are ready to start transacting!</p>
                            </div>
                          </div>
                        </td>
                      </tr>
                    ...
                    <table width="480" border="0" cellspacing="0" cellpadding="0" align="center">
                      ...
                      <tr>
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              <h2 style="font-size: 20px;">Let's Get Started</h2>
                              <br>
                              <p>Simply click the button below to log into your account. Your username is [+user_name+].
                              </p>
                              <br><br>
