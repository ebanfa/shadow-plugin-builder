                        ...
                        <td valign="middle" style='vertical-align: middle;'>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: left;font-weight: light; color:#555555;font-size:14px;line-height: 16px;font-family: "Helvetica Neue Light",Helvetica,Arial,sans-serif;;'>
                              <a target='_blank' href="[CLIENTS.WEBSITE]" style='color:#444444'><strong>Reference: [+appl_no+]</strong></a>
                            </div>
                          </div>
                        </td>
                        <td width='10'></td>
                    ...
                    <table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
                      ...
                      <tr>
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              <h2 style="color: #fff; font-size: 20px;">Thank you for placing your credit application.</h2>
                              <br>
                              <p style="color: #fff;">Your applications is being reviewed and we shall get in touch with you shortly.</p>
                            </div>
                          </div>
                        </td>
                      </tr>
                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              ...
                              <br>
                              <p style="color:#fff;">Simply log into your account to track the progress of your application.
                              </p>
                              <br><br>
