                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              ...
                              <br>
                              <p style="color: #fff;">An account has been created for you to help you better manage your credit application(s).</p>
                            </div>
                          </div>
                        </td>
                      </tr>
                    ...
                    <table width="480" border="0" cellspacing="0" cellpadding="0" align="center">
                      ...
                      <tr>
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              <h2 style="font-size: 20px;">Review you application Status</h2>
                              <br>
                              <p>You can review the status of your application(s) with the following account details. Your username is [+user_name+], and your current password is [+password+]
                              </p>
                              <br><br>
