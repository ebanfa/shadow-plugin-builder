<?php
    ...
    $content_files = EntityAPI::find_by_criteria('productcategoryimage', array('prod_cat_image' =>  $model['id']));
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="upload-file-form" action=""  method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="id" value="<?php echo $model['id']; ?>">
                    <input type="hidden" name="action" value="upload_product_category_images_file_ajax" /> 
                    <input type="hidden" name="artifact" value="<?php echo $view->get_artifact_name(); ?>"> 
                    <?php wp_nonce_field('post_nonce', 'post_nonce_field'); ?>
                    <input type="hidden" name="submitted" id="submitted" value="true" />
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <span class="btn btn-success fileinput-button">
                                ...
                                <input id="fileupload" type="file" name="product_category_images[]" multiple>
                            </span>
                            <br>
                            <br>
