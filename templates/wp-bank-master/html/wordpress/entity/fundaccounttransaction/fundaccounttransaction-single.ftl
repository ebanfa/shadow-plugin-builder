...
<div class="tab-content p-20">
    ...
    <?php } } ?>
        ...
        <div class="btn-demo m-t-10">
            ...
            <a id="cancel-entity-btn" href="<?php echo EntityActionProcessor::get_base_url() . 'artifact=' . $view->get_artifact_name() . '&page_action=list'?>" class="btn btn-warning waves-effect">
