...
class EntityController {
    ...
    public static function do_before_ajax_edit($entity_data) {
        ...
        $entity_data = EntityControllerUtils::init_entity_data($artifact_name);
    ...
    public static function do_create_entity($entity_data){
        ...
        if ($entity_data['edit_mode']) {
            ...
            $entity_data = EntityPersistenceController::create_entity($entity_data);
        } else {
            EntityRequestUtils::copy_fields_to_post($entity_data);
            // Edit mode dont need redirect...for now
            $entity_data['requires_redirect'] = false;
            $entity_data = EntityPersistenceController::update_entity($entity_data);
        }
    ...
    public static function do_find_entity($entity_data) {
        ...
        return EntityPersistenceController::find_by_criteria($artifact_name, $criteria_data);
    }
    ...
    public static function get_by_id($artifact_name, $id){
        $entity_data = EntityControllerUtils::init_entity_data($artifact_name);
        return EntityPersistenceController::get_entity_by_id($entity_data, $id);
    }
    ...
    public static function get_by_code($artifact_name, $entity_code){
        $entity_data = EntityControllerUtils::init_entity_data($artifact_name);
        return EntityPersistenceController::get_entity_by_code($entity_data, $entity_code);
    }
    ...
    public static function get_by_field($artifact_name, $field_name, $field_value){
        $entity_data = EntityControllerUtils::init_entity_data($artifact_name);
        return EntityPersistenceController::get_entity_by_meta($entity_data, $field_name, $field_value);
    }
    ...
    public static function find_by_ids($artifact_name, $party_ids) {
        $entity_data = EntityControllerUtils::init_entity_data($artifact_name);
        return EntityPersistenceController::find_by_ids($entity_data, $party_ids);
    }
    ...
    public static function find_by_criteria($artifact_name, $criteria_data) {
        $entity_data = EntityControllerUtils::init_entity_data($artifact_name);
        return EntityPersistenceController::find_by_criteria($entity_data, $criteria_data);
    }
