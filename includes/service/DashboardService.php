...
class DashboardService {
    ...
    public static function get_party_dashboard_stats($party_id){
    	...
    	$party_dashboard_stats['property_count'] =  0;//$property_count;
    	$party_dashboard_stats['tenants_count'] =  0;//$tenants_count;
    	$party_dashboard_stats['lease_agreements_value'] = 0;//$lease_agreements_value;
